.class public final Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;",
        "Lcom/apollographql/apollo3/api/Adapter;",
        "Lcom/box/android/data/MoveItemMutation$FileLock;",
        "<init>",
        "()V",
...
# static fields
.field public static final INSTANCE:Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;

    invoke-direct {v0}, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;-><init>()V

    sput-object v0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->INSTANCE:Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;
    ...
    sput-object v0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->RESPONSE_NAMES:Ljava/util/List;
...
# virtual methods
.method public fromJson(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lcom/box/android/data/MoveItemMutation$FileLock;
    .locals 9
    ...
    .line 685
    :goto_0
    sget-object v0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->RESPONSE_NAMES:Ljava/util/List;
    ...
    .line 690
    :cond_2
    sget-object v0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$CreatedBy;->INSTANCE:Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$CreatedBy;
    ...
    check-cast v4, Lcom/box/android/data/MoveItemMutation$CreatedBy;
...
.method public bridge synthetic fromJson(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Ljava/lang/Object;
    ...
    .line 671
    invoke-virtual {p0, p1, p2}, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->fromJson(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lcom/box/android/data/MoveItemMutation$FileLock;
...
.method public final getRESPONSE_NAMES()Ljava/util/List;
    ...
    .line 672
    sget-object p0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->RESPONSE_NAMES:Ljava/util/List;

    return-object p0
.end method

.method public toJson(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lcom/box/android/data/MoveItemMutation$FileLock;)V
    .locals 3
    ...
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->getId()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->getAppType()Ljava/lang/String;
    ...
    .line 721
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->getCreatedAt()Ljava/util/Date;
    ...
    .line 724
    sget-object p0, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$CreatedBy;->INSTANCE:Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$CreatedBy;
    ...
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->getCreatedBy()Lcom/box/android/data/MoveItemMutation$CreatedBy;
    ...
    .line 728
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->getExpiresAt()Ljava/util/Date;
    ...
    invoke-virtual {p3}, Lcom/box/android/data/MoveItemMutation$FileLock;->isDownloadPrevented()Ljava/lang/Boolean;
...
.method public bridge synthetic toJson(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Ljava/lang/Object;)V
    ...
    .line 671
    check-cast p3, Lcom/box/android/data/MoveItemMutation$FileLock;

    invoke-virtual {p0, p1, p2, p3}, Lcom/box/android/data/adapter/MoveItemMutation_ResponseAdapter$FileLock;->toJson(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lcom/box/android/data/MoveItemMutation$FileLock;)V
