.class public final Lcom/box/android/data/api/models/upload/UploadSessionCreationState;
...
.method public constructor <init>(Lcom/box/android/data/jobs/JobService;Lcom/box/android/data/jobs/UploadFileJobV2;Lcom/box/android/data/service/impl/UploadFileService;Lcom/box/android/data/service/impl/LocalItemService;Lcom/box/android/data/service/impl/CommonServiceUtils;Lcom/box/android/domain/services/IdMappingService;)V
    ...
    .line 345
    iput-object p1, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->jobService:Lcom/box/android/data/jobs/JobService;

    .line 346
    iput-object p2, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->job:Lcom/box/android/data/jobs/UploadFileJobV2;

    .line 347
    iput-object p3, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->uploadFileService:Lcom/box/android/data/service/impl/UploadFileService;

    .line 348
    iput-object p4, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->localItemService:Lcom/box/android/data/service/impl/LocalItemService;

    .line 349
    iput-object p5, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->commonServiceUtils:Lcom/box/android/data/service/impl/CommonServiceUtils;

    .line 350
    iput-object p6, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->idMappingService:Lcom/box/android/domain/services/IdMappingService;
...
.method public final getCommonServiceUtils()Lcom/box/android/data/service/impl/CommonServiceUtils;
    ...
    .line 349
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->commonServiceUtils:Lcom/box/android/data/service/impl/CommonServiceUtils;
...
.method public final getIdMappingService()Lcom/box/android/domain/services/IdMappingService;
    ...
    .line 350
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->idMappingService:Lcom/box/android/domain/services/IdMappingService;
...
.method public final getJob()Lcom/box/android/data/jobs/UploadFileJobV2;
    ...
    .line 346
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->job:Lcom/box/android/data/jobs/UploadFileJobV2;
...
.method public final getJobService()Lcom/box/android/data/jobs/JobService;
    ...
    .line 345
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->jobService:Lcom/box/android/data/jobs/JobService;
...
.method public final getLocalItemService()Lcom/box/android/data/service/impl/LocalItemService;
    ...
    .line 348
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->localItemService:Lcom/box/android/data/service/impl/LocalItemService;
...
.method public final getUploadFileService()Lcom/box/android/data/service/impl/UploadFileService;
    ...
    .line 347
    iget-object p0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->uploadFileService:Lcom/box/android/data/service/impl/UploadFileService;
...
.method public onEnter(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 352
    iget-object v0, p0, Lcom/box/android/data/api/models/upload/UploadSessionCreationState;->job:Lcom/box/android/data/jobs/UploadFileJobV2;

    new-instance v1, Lcom/box/android/data/api/models/upload/UploadSessionCreationState$onEnter$2;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/box/android/data/api/models/upload/UploadSessionCreationState$onEnter$2;-><init>(Lcom/box/android/data/api/models/upload/UploadSessionCreationState;Lkotlin/coroutines/Continuation;)V
