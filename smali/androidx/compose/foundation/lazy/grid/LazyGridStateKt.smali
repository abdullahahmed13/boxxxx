...
.method public static synthetic $r8$lambda$Oqcv3kxMGgB_Adt-gOCSPZ0MaPg(I)I
    .locals 0
...
.method public static synthetic $r8$lambda$_SHGNlTQvKmgss8e6XSR5oGmWgo(I)Ljava/util/List;
    .locals 0
...
.method public static final rememberLazyGridState(IILandroidx/compose/foundation/lazy/grid/LazyGridPrefetchStrategy;Landroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/lazy/grid/LazyGridState;
    ...
    const-string v0, "C(rememberLazyGridState)N(initialFirstVisibleItemIndex,initialFirstVisibleItemScrollOffset,prefetchStrategy)102@4719L39,104@4872L161,104@4790L243:LazyGridState.kt#7791vq"
    ...
    .line 103
    invoke-static {v2, v4, p2}, Landroidx/compose/foundation/lazy/grid/LazyGridPrefetchStrategyKt;->LazyGridPrefetchStrategy$default(IILjava/lang/Object;)Landroidx/compose/foundation/lazy/grid/LazyGridPrefetchStrategy;
    ...
    const-string v5, "androidx.compose.foundation.lazy.grid.rememberLazyGridState (LazyGridState.kt:103)"
    ...
    invoke-virtual {v1, p2}, Landroidx/compose/foundation/lazy/grid/LazyGridState$Companion;->saver$foundation(Landroidx/compose/foundation/lazy/grid/LazyGridPrefetchStrategy;)Landroidx/compose/runtime/saveable/Saver;
...
.method public static final rememberLazyGridState(IILandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/lazy/grid/LazyGridState;
    ...
    const-string v0, "C(rememberLazyGridState)N(initialFirstVisibleItemIndex,initialFirstVisibleItemScrollOffset)80@3856L96,80@3810L142:LazyGridState.kt#7791vq"
    ...
    .line 81
    :cond_9
    new-instance v1, Landroidx/compose/foundation/lazy/grid/LazyGridStateKt$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0, p1}, Landroidx/compose/foundation/lazy/grid/LazyGridStateKt$$ExternalSyntheticLambda1;-><init>(II)V
...
.method public static final rememberLazyGridState(Landroidx/compose/foundation/lazy/layout/LazyLayoutCacheWindow;IILandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/lazy/grid/LazyGridState;
    ...
    const-string v0, "C(rememberLazyGridState)N(cacheWindow,initialFirstVisibleItemIndex,initialFirstVisibleItemScrollOffset)132@5906L156,132@5834L228:LazyGridState.kt#7791vq"
    ...
    const-string v3, "androidx.compose.foundation.lazy.grid.rememberLazyGridState (LazyGridState.kt:131)"
    ...
    invoke-virtual {v1, p0}, Landroidx/compose/foundation/lazy/grid/LazyGridState$Companion;->saver$foundation(Landroidx/compose/foundation/lazy/layout/LazyLayoutCacheWindow;)Landroidx/compose/runtime/saveable/Saver;

    move-result-object v1

    const v3, 0x6fb7490

    const-string v4, "CC(remember):LazyGridState.kt#9igjgp"
