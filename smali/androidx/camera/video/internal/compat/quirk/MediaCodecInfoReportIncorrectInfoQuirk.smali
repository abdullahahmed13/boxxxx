...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "m2004j19c"
    ...
    const-string/jumbo v2, "v2204"

    aput-object v2, v0, v1

    const/16 v1, 0xa

    const-string v2, "23078pnd5g"

    aput-object v2, v0, v1

    const/16 v1, 0xb

    const-string/jumbo v2, "pht110"

    aput-object v2, v0, v1

    const/16 v1, 0xc

    const-string v2, "23053rn02l"

    aput-object v2, v0, v1

    const/16 v1, 0xd

    const-string/jumbo v2, "rmx3710"

    aput-object v2, v0, v1

    const/16 v1, 0xe

    const-string/jumbo v2, "rmx3511"

    aput-object v2, v0, v1

    const/16 v1, 0xf

    const-string/jumbo v2, "v2207"
...
.method private static isX650()Z
    ...
    const-string/jumbo v0, "infinix x650"
...
.method public isUnSupportMediaCodecInfo(Landroid/media/MediaFormat;)Z
    ...
    .line 154
    new-instance p0, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;

    invoke-direct {p0, p1}, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;-><init>(Landroid/media/MediaFormat;)V
    ...
    .line 160
    invoke-virtual {p0}, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;->isAvc()Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;->isSize(II)Z
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0}, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;->isVideo()Z
    ...
    :cond_5
    :goto_1
    invoke-virtual {p0}, Landroidx/camera/video/internal/compat/quirk/MediaCodecInfoReportIncorrectInfoQuirk$MediaFormatResolver;->isMpeg4()Z
