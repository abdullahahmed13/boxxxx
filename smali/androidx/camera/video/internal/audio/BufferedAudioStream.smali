...
.method private checkNotReleasedOrThrow()V
    ...
    .line 214
    iget-object p0, p0, Landroidx/camera/video/internal/audio/BufferedAudioStream;->mIsReleased:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private checkStartedOrThrow()V
    ...
    .line 218
    iget-object p0, p0, Landroidx/camera/video/internal/audio/BufferedAudioStream;->mIsStarted:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private updateCollectionBufferSize(I)V
    ...
    iget p0, p0, Landroidx/camera/video/internal/audio/BufferedAudioStream;->mBufferSize:I
...
.method synthetic lambda$release$2$androidx-camera-video-internal-audio-BufferedAudioStream()V
    ...
    .line 150
    iget-object p0, p0, Landroidx/camera/video/internal/audio/BufferedAudioStream;->mAudioDataQueue:Ljava/util/Queue;
...
.method synthetic lambda$setCallback$3$androidx-camera-video-internal-audio-BufferedAudioStream(Landroidx/camera/video/internal/audio/AudioStream$AudioStreamCallback;Ljava/util/concurrent/Executor;)V
    ...
    .line 210
    iget-object p0, p0, Landroidx/camera/video/internal/audio/BufferedAudioStream;->mAudioStream:Landroidx/camera/video/internal/audio/AudioStream;

    invoke-interface {p0, p1, p2}, Landroidx/camera/video/internal/audio/AudioStream;->setCallback(Landroidx/camera/video/internal/audio/AudioStream$AudioStreamCallback;Ljava/util/concurrent/Executor;)V
...
.method public read(Ljava/nio/ByteBuffer;)Landroidx/camera/video/internal/audio/AudioStream$PacketInfo;
    ...
    invoke-static {p1, v1, p0}, Landroidx/camera/core/Logger;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
