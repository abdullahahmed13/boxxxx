...
.method private getRemainingRotationDegrees()I
    ...
    .line 186
    iget p0, p0, Landroidx/camera/view/PreviewTransformation;->mPreviewRotationDegrees:I

    return p0

    .line 191
    :cond_0
    iget p0, p0, Landroidx/camera/view/PreviewTransformation;->mTargetRotation:I
...
.method private getRotatedViewportSize()Landroid/util/Size;
    ...
    iget-object p0, p0, Landroidx/camera/view/PreviewTransformation;->mSurfaceCropRect:Landroid/graphics/Rect;
...
.method private getTransformedSurfaceRect(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object p0, p0, Landroidx/camera/view/PreviewTransformation;->mResolution:Landroid/util/Size;
...
.method getPreviewViewViewportRectForMismatchedAspectRatios(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    invoke-static {v1, v2, v0, p0}, Landroidx/camera/view/PreviewTransformation;->setMatrixRectToRect(Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/graphics/RectF;Landroidx/camera/view/PreviewView$ScaleType;)V
    ...
    invoke-static {v2, p0}, Landroidx/camera/view/PreviewTransformation;->flipHorizontally(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method getTextureViewCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    .line 170
    invoke-static {v0, v0, p0}, Landroidx/camera/core/impl/utils/TransformUtils;->getRectToRect(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
...
.method isViewportAspectRatioMatchPreviewView(Landroid/util/Size;)Z
    ...
    .line 425
    invoke-static {p1, v0, p0, v1}, Landroidx/camera/core/impl/utils/TransformUtils;->isAspectRatioMatchingWithRoundingError(Landroid/util/Size;ZLandroid/util/Size;Z)Z
