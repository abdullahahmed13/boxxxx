...
.method public onDatabaseReset(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-object p0, p0, Lcom/amplitude/api/AmplitudeClient$2;->val$client:Lcom/amplitude/api/AmplitudeClient;

    iget-wide v3, p0, Lcom/amplitude/api/AmplitudeClient;->lastEventTime:J
    ...
    invoke-virtual {v0, p1, v2, v1, p0}, Lcom/amplitude/api/DatabaseHelper;->insertOrReplaceKeyValueToTable(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)J
