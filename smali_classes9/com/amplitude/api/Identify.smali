...
.method private addToUserProperties(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    const-string p3, "Attempting to perform operation %s with a null or empty string property, ignoring"
    ...
    invoke-virtual {p0, p2, p1}, Lcom/amplitude/api/AmplitudeLog;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v0, "Attempting to perform operation %s with null value for property %s, ignoring"
    ...
    invoke-virtual {p0, p3, p1}, Lcom/amplitude/api/AmplitudeLog;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string p3, "This Identify already contains a $clearAll operation, ignoring operation %s"
    ...
    const-string v0, "Already used property %s in previous operation, ignoring operation %s"
    ...
    .line 1642
    iget-object p0, p0, Lcom/amplitude/api/Identify;->userProperties:Ljava/util/Set;
...
.method private booleanArrayToJSONArray([Z)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0, v2}, Lorg/json/JSONArray;->put(Z)Lorg/json/JSONArray;
...
.method private doubleArrayToJSONArray([D)Lorg/json/JSONArray;
    ...
    sget-object v6, Lcom/amplitude/api/Identify;->TAG:Ljava/lang/String;
    ...
    .line 1674
    const-string v3, "Error converting double %d to JSON: %s"

    invoke-static {v3, v2}, Ljava/lang/String;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v6, v2}, Lcom/amplitude/api/AmplitudeLog;->e(Ljava/lang/String;Ljava/lang/String;)I
...
.method private floatArrayToJSONArray([F)Lorg/json/JSONArray;
    ...
    .line 1658
    :try_start_0
    invoke-virtual {p0, v3, v4}, Lorg/json/JSONArray;->put(D)Lorg/json/JSONArray;
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-object v5, Lcom/amplitude/api/Identify;->TAG:Ljava/lang/String;
    ...
    .line 1660
    const-string v3, "Error converting float %f to JSON: %s"

    invoke-static {v3, v2}, Ljava/lang/String;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v4, v5, v2}, Lcom/amplitude/api/AmplitudeLog;->e(Ljava/lang/String;Ljava/lang/String;)I
...
.method private longArrayToJSONArray([J)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0, v2, v3}, Lorg/json/JSONArray;->put(J)Lorg/json/JSONArray;
...
.method public getUserPropertiesOperations()Lorg/json/JSONObject;
    ...
    iget-object p0, p0, Lcom/amplitude/api/Identify;->userPropertiesOperations:Lorg/json/JSONObject;
    ...
    invoke-virtual {v0, v1, p0}, Lcom/amplitude/api/AmplitudeLog;->e(Ljava/lang/String;Ljava/lang/String;)I
