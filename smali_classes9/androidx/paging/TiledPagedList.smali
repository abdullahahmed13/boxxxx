...
.method constructor <init>(Landroidx/paging/PositionalDataSource;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Landroidx/paging/PagedList$BoundaryCallback;Landroidx/paging/PagedList$Config;I)V
    ...
    .line 32
    new-instance p0, Landroidx/paging/TiledPagedList$1;

    invoke-direct {p0, v0}, Landroidx/paging/TiledPagedList$1;-><init>(Landroidx/paging/TiledPagedList;)V

    iput-object p0, v0, Landroidx/paging/TiledPagedList;->mReceiver:Landroidx/paging/PageResult$Receiver;

    .line 93
    iput-object p1, v0, Landroidx/paging/TiledPagedList;->mDataSource:Landroidx/paging/PositionalDataSource;

    .line 95
    iget-object p0, v0, Landroidx/paging/TiledPagedList;->mConfig:Landroidx/paging/PagedList$Config;

    iget v4, p0, Landroidx/paging/PagedList$Config;->pageSize:I

    .line 96
    iput p6, v0, Landroidx/paging/TiledPagedList;->mLastLoad:I
    ...
    iget p0, p0, Landroidx/paging/PagedList$Config;->initialLoadSizeHint:I
    ...
    .line 107
    iget-object v5, v0, Landroidx/paging/TiledPagedList;->mMainThreadExecutor:Ljava/util/concurrent/Executor;

    iget-object v6, v0, Landroidx/paging/TiledPagedList;->mReceiver:Landroidx/paging/PageResult$Receiver;
...
.method public getLastKey()Ljava/lang/Object;
    ...
    .line 126
    iget p0, p0, Landroidx/paging/TiledPagedList;->mLastLoad:I
