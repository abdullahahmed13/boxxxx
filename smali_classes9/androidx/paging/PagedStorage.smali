...
.method private needsTrim(III)Z
    ...
    iget p0, p0, Landroidx/paging/PagedStorage;->mLoadedCount:I
...
.method appendPage(Ljava/util/List;Landroidx/paging/PagedStorage$Callback;)V
    ...
    iget p0, p0, Landroidx/paging/PagedStorage;->mStorageCount:I
...
.method public get(I)Ljava/lang/Object;
    ...
    :cond_3
    :goto_1
    iget-object p0, p0, Landroidx/paging/PagedStorage;->mPages:Ljava/util/ArrayList;
...
.method getLeadingNullCount()I
    ...
    .line 185
    iget p0, p0, Landroidx/paging/PagedStorage;->mLeadingNullCount:I
...
.method getNumberAppended()I
    ...
    .line 197
    iget p0, p0, Landroidx/paging/PagedStorage;->mNumberAppended:I
...
.method getNumberPrepended()I
    ...
    .line 201
    iget p0, p0, Landroidx/paging/PagedStorage;->mNumberPrepended:I
...
.method getPositionOffset()I
    ...
    .line 225
    iget p0, p0, Landroidx/paging/PagedStorage;->mPositionOffset:I
...
.method getTrailingNullCount()I
    ...
    .line 189
    iget p0, p0, Landroidx/paging/PagedStorage;->mTrailingNullCount:I
...
.method public hasPage(II)Z
    ...
    .line 635
    sget-object p2, Landroidx/paging/PagedStorage;->PLACEHOLDER_LIST:Ljava/util/List;
...
.method initAndSplit(ILjava/util/List;IIILandroidx/paging/PagedStorage$Callback;)V
    ...
    invoke-interface {p6, p0}, Landroidx/paging/PagedStorage$Callback;->onInitialized(I)V
...
.method public insertPage(ILjava/util/List;Landroidx/paging/PagedStorage$Callback;)V
    ...
    const-string p2, ": data already loaded"
...
.method isTiled()Z
    ...
    .line 181
    iget p0, p0, Landroidx/paging/PagedStorage;->mPageSize:I
...
.method prependPage(Ljava/util/List;Landroidx/paging/PagedStorage$Callback;)V
    ...
    invoke-interface {p2, p0, p1, v1}, Landroidx/paging/PagedStorage$Callback;->onPagePrepended(III)V
