...
.method public onResult(Ljava/util/List;IILjava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 272
    iget-object p0, p0, Landroidx/paging/PageKeyedDataSource$LoadInitialCallbackImpl;->mCallbackHelper:Landroidx/paging/DataSource$LoadCallbackHelper;

    new-instance p4, Landroidx/paging/PageResult;

    const/4 p5, 0x0

    invoke-direct {p4, p1, p2, p3, p5}, Landroidx/paging/PageResult;-><init>(Ljava/util/List;III)V

    invoke-virtual {p0, p4}, Landroidx/paging/DataSource$LoadCallbackHelper;->dispatchResultToReceiver(Landroidx/paging/PageResult;)V
    ...
    invoke-direct {p3, p1, p2}, Landroidx/paging/PageResult;-><init>(Ljava/util/List;I)V

    invoke-virtual {p0, p3}, Landroidx/paging/DataSource$LoadCallbackHelper;->dispatchResultToReceiver(Landroidx/paging/PageResult;)V
...
.method public onResult(Ljava/util/List;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    new-instance p2, Landroidx/paging/PageResult;

    const/4 p3, 0x0

    invoke-direct {p2, p1, p3, p3, p3}, Landroidx/paging/PageResult;-><init>(Ljava/util/List;III)V

    invoke-virtual {p0, p2}, Landroidx/paging/DataSource$LoadCallbackHelper;->dispatchResultToReceiver(Landroidx/paging/PageResult;)V
