...
.method constructor <init>(Landroidx/paging/ContiguousDataSource;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Landroidx/paging/PagedList$BoundaryCallback;Landroidx/paging/PagedList$Config;Ljava/lang/Object;I)V
    ...
    .line 43
    iput p0, v0, Landroidx/paging/ContiguousPagedList;->mPrependWorkerState:I

    .line 46
    iput p0, v0, Landroidx/paging/ContiguousPagedList;->mAppendWorkerState:I

    .line 50
    iput p0, v0, Landroidx/paging/ContiguousPagedList;->mPrependItemsRequested:I

    .line 52
    iput p0, v0, Landroidx/paging/ContiguousPagedList;->mAppendItemsRequested:I

    .line 55
    iput-boolean p0, v0, Landroidx/paging/ContiguousPagedList;->mReplacePagesWithNulls:Z

    .line 61
    new-instance p2, Landroidx/paging/ContiguousPagedList$1;

    invoke-direct {p2, v0}, Landroidx/paging/ContiguousPagedList$1;-><init>(Landroidx/paging/ContiguousPagedList;)V

    iput-object p2, v0, Landroidx/paging/ContiguousPagedList;->mReceiver:Landroidx/paging/PageResult$Receiver;

    .line 169
    iput-object p1, v0, Landroidx/paging/ContiguousPagedList;->mDataSource:Landroidx/paging/ContiguousDataSource;

    .line 170
    iput p7, v0, Landroidx/paging/ContiguousPagedList;->mLastLoad:I
    ...
    .line 175
    :cond_0
    iget-object p2, v0, Landroidx/paging/ContiguousPagedList;->mConfig:Landroidx/paging/PagedList$Config;

    iget v3, p2, Landroidx/paging/PagedList$Config;->initialLoadSizeHint:I
    ...
    iget-boolean v5, p2, Landroidx/paging/PagedList$Config;->enablePlaceholders:Z

    iget-object v6, v0, Landroidx/paging/ContiguousPagedList;->mMainThreadExecutor:Ljava/util/concurrent/Executor;

    iget-object v7, v0, Landroidx/paging/ContiguousPagedList;->mReceiver:Landroidx/paging/PageResult$Receiver;

    move-object v1, p1

    move-object v2, p6

    invoke-virtual/range {v1 .. v7}, Landroidx/paging/ContiguousDataSource;->dispatchLoadInitial(Ljava/lang/Object;IIZLjava/util/concurrent/Executor;Landroidx/paging/PageResult$Receiver;)V

    .line 182
    :goto_0
    invoke-virtual {v1}, Landroidx/paging/ContiguousDataSource;->supportsPageDropping()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, v0, Landroidx/paging/ContiguousPagedList;->mConfig:Landroidx/paging/PagedList$Config;
    ...
    :cond_1
    iput-boolean p0, v0, Landroidx/paging/ContiguousPagedList;->mShouldTrim:Z
...
.method dispatchUpdatesSinceSnapshot(Landroidx/paging/PagedList;Landroidx/paging/PagedList$Callback;)V
    ...
    iget-object p0, p0, Landroidx/paging/ContiguousPagedList;->mStorage:Landroidx/paging/PagedStorage;
    ...
    .line 217
    invoke-virtual {p2, v2, p0}, Landroidx/paging/PagedList$Callback;->onChanged(II)V
    ...
    .line 220
    invoke-virtual {p2, v2, v0}, Landroidx/paging/PagedList$Callback;->onInserted(II)V
    ...
    .line 228
    invoke-virtual {p2, v3, p0}, Landroidx/paging/PagedList$Callback;->onChanged(II)V
...
.method public getLastKey()Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/paging/ContiguousPagedList;->mLastItem:Ljava/lang/Object;

    invoke-virtual {v0, v1, p0}, Landroidx/paging/ContiguousDataSource;->getKey(ILjava/lang/Object;)Ljava/lang/Object;
