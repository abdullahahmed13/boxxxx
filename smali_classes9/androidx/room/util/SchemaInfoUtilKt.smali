...
.method private static final readColumns(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p1, v3}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
    ...
    invoke-static {p1, v4}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I

    move-result v4

    .line 168
    const-string v5, "dflt_value"

    invoke-static {p1, v5}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
    ...
    .line 177
    invoke-interface {p1, v5}, Landroidx/sqlite/SQLiteStatement;->isNull(I)Z
...
.method private static final readForeignKeys(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {v0, v2}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
    ...
    invoke-static {v0, v3}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
    ...
    .line 94
    invoke-virtual {v14}, Landroidx/room/util/ForeignKeyWithSequence;->getId()I
    ...
    check-cast v11, Landroidx/room/util/ForeignKeyWithSequence;

    .line 96
    invoke-virtual {v11}, Landroidx/room/util/ForeignKeyWithSequence;->getFrom()Ljava/lang/String;
    ...
    .line 97
    invoke-virtual {v11}, Landroidx/room/util/ForeignKeyWithSequence;->getTo()Ljava/lang/String;
...
.method private static final readIndex(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {v2, v3}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
...
.method private static final readIndices(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {v0, v1}, Landroidx/room/util/SQLiteStatementUtil;->columnIndexOf(Landroidx/sqlite/SQLiteStatement;Ljava/lang/String;)I
    ...
    .line 215
    :goto_1
    invoke-static {p0, v6, v7}, Landroidx/room/util/SchemaInfoUtilKt;->readIndex(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
...
.method public static final readViewInfo(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;)Landroidx/room/util/ViewInfo;
    ...
    invoke-direct {p1, v1, v0}, Landroidx/room/util/ViewInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, v2}, Landroidx/room/util/ViewInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
