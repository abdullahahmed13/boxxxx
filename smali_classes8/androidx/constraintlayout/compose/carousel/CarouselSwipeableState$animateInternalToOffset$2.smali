...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 204
    iget v2, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->label:I
    ...
    iget-object v2, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->L$0:Ljava/lang/Object;
    ...
    iget-object v7, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->this$0:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;

    invoke-static {v7}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$getAbsoluteOffset$p(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;)Landroidx/compose/runtime/MutableFloatState;
    ...
    invoke-static {v7}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$getAnimationTarget$p(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;)Landroidx/compose/runtime/MutableState;

    move-result-object v7

    iget v8, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->$target:F
    ...
    invoke-static {v7, v5}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$setAnimationRunning(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Z)V
    ...
    iget v7, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->$target:F

    invoke-static {v7}, Lkotlin/coroutines/jvm/internal/Boxing;->boxFloat(F)Ljava/lang/Float;

    move-result-object v11

    iget-object v12, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->$spec:Landroidx/compose/animation/core/AnimationSpec;

    new-instance v7, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2$1;

    invoke-direct {v7, v2, v6}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2$1;-><init>(Landroidx/compose/foundation/gestures/DragScope;Lkotlin/jvm/internal/Ref$FloatRef;)V
    ...
    iput v5, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->label:I
    ...
    :cond_2
    :goto_0
    iget-object v0, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->this$0:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;
    ...
    invoke-static {v0, v3}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$setAnimationRunning(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Z)V
    ...
    .line 214
    :goto_1
    iget-object v2, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->this$0:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;

    invoke-static {v2}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$getAnimationTarget$p(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;)Landroidx/compose/runtime/MutableState;
    ...
    .line 215
    iget-object v1, v1, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState$animateInternalToOffset$2;->this$0:Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;

    invoke-static {v1, v3}, Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;->access$setAnimationRunning(Landroidx/constraintlayout/compose/carousel/CarouselSwipeableState;Z)V
