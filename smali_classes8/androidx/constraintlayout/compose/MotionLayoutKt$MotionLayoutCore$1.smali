...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v0, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$motionScene:Landroidx/constraintlayout/compose/MotionScene;

    iget-object v1, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$constraintSetName:Ljava/lang/String;

    iget-object v2, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$animationSpec:Landroidx/compose/animation/core/AnimationSpec;

    iget-object v3, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$modifier:Landroidx/compose/ui/Modifier;

    iget-object v4, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$finishedAnimationListener:Lkotlin/jvm/functions/Function0;

    iget v5, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$debugFlags:I

    iget v6, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$optimizationLevel:I

    iget-object v7, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$contentTracker:Landroidx/compose/runtime/MutableState;

    iget-object v8, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$compositionSource:Landroidx/compose/ui/node/Ref;

    iget-object v9, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$invalidationStrategy:Landroidx/constraintlayout/compose/InvalidationStrategy;

    iget-object v10, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$content:Lkotlin/jvm/functions/Function3;

    iget v11, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$$changed:I
    ...
    iget v11, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$$changed1:I

    invoke-static {v11}, Landroidx/compose/runtime/RecomposeScopeImplKt;->updateChangedFlags(I)I

    move-result v13

    iget v14, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$MotionLayoutCore$1;->$$default:I
