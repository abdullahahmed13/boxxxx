...
# direct methods
.method constructor <init>(Landroid/content/Context;Landroidx/media3/session/MediaBrowser;Landroidx/media3/session/SessionToken;Landroid/os/Bundle;Landroid/os/Looper;Z)V
    .locals 0

    .line 56
    invoke-direct/range {p0 .. p6}, Landroidx/media3/session/MediaControllerImplBase;-><init>(Landroid/content/Context;Landroidx/media3/session/MediaController;Landroidx/media3/session/SessionToken;Landroid/os/Bundle;Landroid/os/Looper;Z)V
...
.method private dispatchRemoteLibrarySessionTask(ILandroidx/media3/session/MediaBrowserImplBase$RemoteLibrarySessionTask;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 198
    invoke-virtual {p0}, Landroidx/media3/session/MediaBrowserImplBase;->notifyPlatformControllerAboutMedia3ChangeRequest()V
    ...
    .line 205
    iget-object p0, p0, Landroidx/media3/session/MediaBrowserImplBase;->sequencedFutureManager:Landroidx/media3/session/SequencedFutureManager;
    ...
    .line 205
    invoke-virtual {p0, p1, p2}, Landroidx/media3/session/SequencedFutureManager;->setFutureResult(ILjava/lang/Object;)V
...
.method public getChildren(Ljava/lang/String;IILandroidx/media3/session/MediaLibraryService$LibraryParams;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, p0, v0}, Landroidx/media3/session/MediaBrowserImplBase;->dispatchRemoteLibrarySessionTask(ILandroidx/media3/session/MediaBrowserImplBase$RemoteLibrarySessionTask;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method getInstance()Landroidx/media3/session/MediaBrowser;
    ...
    .line 68
    iget-object p0, p0, Landroidx/media3/session/MediaBrowserImplBase;->instance:Landroidx/media3/session/MediaBrowser;
