...
.method private getQueuedMediaItem(I)Landroidx/media3/session/QueueTimeline$QueuedMediaItem;
    ...
    .line 273
    :cond_0
    iget-object p0, p0, Landroidx/media3/session/QueueTimeline;->queuedMediaItems:Lcom/google/common/collect/ImmutableList;

    invoke-virtual {p0, p1}, Lcom/google/common/collect/ImmutableList;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;
...
.method public copy()Landroidx/media3/session/QueueTimeline;
    ...
    iget-object p0, p0, Landroidx/media3/session/QueueTimeline;->fakeQueuedMediaItem:Landroidx/media3/session/QueueTimeline$QueuedMediaItem;

    invoke-direct {v0, v1, p0}, Landroidx/media3/session/QueueTimeline;-><init>(Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/QueueTimeline$QueuedMediaItem;)V
...
.method public copyWithClearedFakeMediaItem()Landroidx/media3/session/QueueTimeline;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/media3/session/QueueTimeline;-><init>(Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/QueueTimeline$QueuedMediaItem;)V
...
.method public copyWithMovedMediaItems(III)Landroidx/media3/session/QueueTimeline;
    ...
    invoke-direct {p1, p2, p0}, Landroidx/media3/session/QueueTimeline;-><init>(Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/QueueTimeline$QueuedMediaItem;)V
...
.method public copyWithNewMediaItem(ILandroidx/media3/common/MediaItem;J)Landroidx/media3/session/QueueTimeline;
    ...
    new-instance v0, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;-><init>(Landroidx/media3/common/MediaItem;JJ)V

    invoke-direct {p1, p0, v0}, Landroidx/media3/session/QueueTimeline;-><init>(Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/QueueTimeline$QueuedMediaItem;)V
    ...
    iget-wide v5, p2, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;->queueId:J
    ...
    .line 127
    iget-object p3, p0, Landroidx/media3/session/QueueTimeline;->queuedMediaItems:Lcom/google/common/collect/ImmutableList;

    invoke-virtual {p3, v1, p1}, Lcom/google/common/collect/ImmutableList;->subList(II)Lcom/google/common/collect/ImmutableList;

    move-result-object p3

    invoke-virtual {p2, p3}, Lcom/google/common/collect/ImmutableList$Builder;->addAll(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    invoke-virtual {p2, v3}, Lcom/google/common/collect/ImmutableList$Builder;->add(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    invoke-virtual {p3, p1, p4}, Lcom/google/common/collect/ImmutableList;->subList(II)Lcom/google/common/collect/ImmutableList;
...
.method public getMediaItemAt(I)Landroidx/media3/common/MediaItem;
    ...
    iget-object p0, p0, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;->mediaItem:Landroidx/media3/common/MediaItem;
...
.method public getPeriod(ILandroidx/media3/common/Timeline$Period;Z)Landroidx/media3/common/Timeline$Period;
    ...
    iget-wide v0, p0, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;->durationMs:J
...
.method public getQueueId(I)J
    ...
    iget-wide p0, p0, Landroidx/media3/session/QueueTimeline$QueuedMediaItem;->queueId:J
