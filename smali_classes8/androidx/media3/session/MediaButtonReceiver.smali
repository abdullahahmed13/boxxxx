...
.method protected final handleIntentAndMaybeStartTheService(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 166
    const-string p0, "Ignore key event that is not a `play` command on API 26 or above to avoid an \'ForegroundServiceDidNotStartInTimeException\'"
    ...
    const-string/jumbo p1, "onReceive(Intent) does not start the media button event target service into the foreground on app request: "
    ...
    sget-object p2, Landroidx/media3/session/MediaButtonReceiver;->ACTIONS:[Ljava/lang/String;
