...
.method private evictChildrenFromSubscription(Ljava/lang/String;)V
    ...
    .line 245
    iget-object p0, p0, Landroidx/media3/session/MediaBrowserImplLegacy;->subscribeCallbacks:Ljava/util/HashMap;
    ...
    check-cast v0, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;

    invoke-static {v0}, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;->access$000(Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;)Ljava/util/List;
    ...
    check-cast p0, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;

    const/4 p1, 0x0

    invoke-static {p0, p1}, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;->access$002(Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;Ljava/util/List;)Ljava/util/List;
...
.method private getBrowserCompat(Landroidx/media3/session/MediaLibraryService$LibraryParams;)Landroidx/media3/session/legacy/MediaBrowserCompat;
    ...
    check-cast p0, Landroidx/media3/session/legacy/MediaBrowserCompat;
...
.method private getChildrenFromSubscription(Ljava/lang/String;I)Ljava/util/List;
    ...
    check-cast v2, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;

    invoke-virtual {v2, p1, p2}, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;->canServeGetChildrenRequest(Ljava/lang/String;I)Z
    ...
    invoke-static {p0}, Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;->access$000(Landroidx/media3/session/MediaBrowserImplLegacy$SubscribeCallback;)Ljava/util/List;
...
.method public getAvailableSessionCommands()Landroidx/media3/session/SessionCommands;
    ...
    invoke-virtual {p0}, Landroidx/media3/session/SessionCommands;->buildUpon()Landroidx/media3/session/SessionCommands$Builder;
    ...
    invoke-virtual {p0}, Landroidx/media3/session/SessionCommands$Builder;->build()Landroidx/media3/session/SessionCommands;
...
.method public getChildren(Ljava/lang/String;IILandroidx/media3/session/MediaLibraryService$LibraryParams;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance p1, Landroidx/media3/session/MediaLibraryService$LibraryParams$Builder;

    invoke-direct {p1}, Landroidx/media3/session/MediaLibraryService$LibraryParams$Builder;-><init>()V

    .line 221
    invoke-virtual {p1, p3}, Landroidx/media3/session/MediaLibraryService$LibraryParams$Builder;->setExtras(Landroid/os/Bundle;)Landroidx/media3/session/MediaLibraryService$LibraryParams$Builder;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/media3/session/MediaLibraryService$LibraryParams$Builder;->build()Landroidx/media3/session/MediaLibraryService$LibraryParams;

    move-result-object p1

    .line 219
    invoke-static {p0, p1}, Landroidx/media3/session/LibraryResult;->ofItemList(Ljava/util/List;Landroidx/media3/session/MediaLibraryService$LibraryParams;)Landroidx/media3/session/LibraryResult;

    move-result-object p0

    .line 218
    invoke-virtual {p4, p0}, Lcom/google/common/util/concurrent/SettableFuture;->set(Ljava/lang/Object;)Z
...
.method getInstance()Landroidx/media3/session/MediaBrowser;
    ...
    .line 82
    iget-object p0, p0, Landroidx/media3/session/MediaBrowserImplLegacy;->instance:Landroidx/media3/session/MediaBrowser;
...
.method public getLibraryRoot(Landroidx/media3/session/MediaLibraryService$LibraryParams;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-static {p0, p1}, Landroidx/media3/session/LibraryResult;->ofItem(Landroidx/media3/common/MediaItem;Landroidx/media3/session/MediaLibraryService$LibraryParams;)Landroidx/media3/session/LibraryResult;
...
.method public unsubscribe(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    check-cast v2, Landroidx/media3/session/legacy/MediaBrowserCompat$SubscriptionCallback;

    invoke-virtual {v0, p1, v2}, Landroidx/media3/session/legacy/MediaBrowserCompat;->unsubscribe(Ljava/lang/String;Landroidx/media3/session/legacy/MediaBrowserCompat$SubscriptionCallback;)V
