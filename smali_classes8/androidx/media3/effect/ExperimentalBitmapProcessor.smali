...
.method private buildPipelineAsync(Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    const-string p1, "BitmapProcessor can only be applied to GlEffect"
    ...
    iget-object p0, p0, Landroidx/media3/effect/ExperimentalBitmapProcessor;->glThreadExecutorService:Lcom/google/common/util/concurrent/ListeningExecutorService;
...
.method private maybeReleasePipeline()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/effect/ExperimentalBitmapProcessor$Pipeline;->releaseAsync()Lcom/google/common/util/concurrent/ListenableFuture;
...
.method private onOutputFrameAvailable(Landroidx/media3/effect/BitmapFrame;)V
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;->addCancellationListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method private processNext(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;Landroid/graphics/Bitmap;)V
    ...
    iget-object p0, p0, Landroidx/media3/effect/ExperimentalBitmapProcessor;->pipelineException:Ljava/lang/Exception;
    ...
    const-string/jumbo p2, "setEffectsAsync has not been called"
...
.method synthetic lambda$releaseAsync$6$androidx-media3-effect-ExperimentalBitmapProcessor()Ljava/lang/Void;
    ...
    .line 280
    iget-object p0, p0, Landroidx/media3/effect/ExperimentalBitmapProcessor;->glObjectsProvider:Landroidx/media3/common/GlObjectsProvider;
...
.method synthetic lambda$releaseAsync$7$androidx-media3-effect-ExperimentalBitmapProcessor()Ljava/lang/Void;
    ...
    invoke-interface {p0}, Lcom/google/common/util/concurrent/ListeningExecutorService;->shutdownNow()Ljava/util/List;
...
.method public setEffectsAsync(Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 193
    iget-object p0, p0, Landroidx/media3/effect/ExperimentalBitmapProcessor;->lastSetEffectsFuture:Lcom/google/common/util/concurrent/ListenableFuture;
