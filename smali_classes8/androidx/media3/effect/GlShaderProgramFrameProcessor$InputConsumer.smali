...
.method private notifyCapacityListener()V
    ...
    .line 307
    :cond_0
    iget-object p0, p0, Landroidx/media3/effect/GlShaderProgramFrameProcessor$InputConsumer;->onCapacityAvailableCallbackReference:Ljava/util/concurrent/atomic/AtomicReference;
...
.method synthetic lambda$queueFrame$0$androidx-media3-effect-GlShaderProgramFrameProcessor$InputConsumer(Landroidx/media3/effect/GlTextureFrame;)Ljava/lang/Object;
    ...
    .line 271
    invoke-static {p0}, Landroidx/media3/effect/GlShaderProgramFrameProcessor;->access$700(Landroidx/media3/effect/GlShaderProgramFrameProcessor;)Landroidx/media3/common/GlObjectsProvider;

    move-result-object p0

    iget-wide v2, p1, Landroidx/media3/effect/GlTextureFrame;->presentationTimeUs:J

    .line 270
    invoke-interface {v1, p0, v0, v2, v3}, Landroidx/media3/effect/GlShaderProgram;->queueInputFrame(Landroidx/media3/common/GlObjectsProvider;Landroidx/media3/common/GlTextureInfo;J)V
...
.method public queueFrame(Landroidx/media3/effect/GlTextureFrame;)Z
    ...
    .line 283
    invoke-static {p0}, Landroidx/media3/effect/GlShaderProgramFrameProcessor;->access$400(Landroidx/media3/effect/GlShaderProgramFrameProcessor;)Lcom/google/common/util/concurrent/ListeningExecutorService;
