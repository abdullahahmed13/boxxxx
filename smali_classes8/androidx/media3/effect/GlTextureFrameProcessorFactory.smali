...
.method private buildShaderPrograms(Landroid/content/Context;Ljava/util/List;Z)Lcom/google/common/collect/ImmutableList;
    ...
    .line 126
    instance-of v3, v2, Landroidx/media3/effect/GlMatrixTransformation;
    ...
    .line 130
    :cond_0
    instance-of v3, v2, Landroidx/media3/effect/RgbMatrix;
    ...
    .line 139
    :cond_2
    invoke-static {p1, v3, v4, p3}, Landroidx/media3/effect/DefaultShaderProgram;->create(Landroid/content/Context;Ljava/util/List;Ljava/util/List;Z)Landroidx/media3/effect/DefaultShaderProgram;
    ...
    .line 144
    :cond_3
    invoke-interface {v2, p1, p3}, Landroidx/media3/effect/GlEffect;->toGlShaderProgram(Landroid/content/Context;Z)Landroidx/media3/effect/GlShaderProgram;
...
.method public buildGlTextureToBitmapFrameProcessor(Z)Landroidx/media3/effect/GlTextureToBitmapFrameProcessor;
    ...
    iget-object p0, p0, Landroidx/media3/effect/GlTextureFrameProcessorFactory;->glObjectsProvider:Landroidx/media3/common/GlObjectsProvider;

    invoke-direct {v0, v1, p1, v2, p0}, Landroidx/media3/effect/GlTextureToBitmapFrameProcessor;-><init>(Landroid/content/Context;ZLcom/google/common/util/concurrent/ListeningExecutorService;Landroidx/media3/common/GlObjectsProvider;)V
