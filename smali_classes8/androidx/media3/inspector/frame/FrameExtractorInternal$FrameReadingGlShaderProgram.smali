...
.method private constructor <init>(Landroid/content/Context;ZLandroidx/media3/inspector/frame/FrameExtractorInternal;)V
    ...
    invoke-direct {v3, p1, v4, v5}, Landroidx/media3/common/util/GlProgram;-><init>(Landroid/content/Context;II)V

    iput-object v3, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->glProgram:Landroidx/media3/common/util/GlProgram;
    :try_end_0
    ...
    invoke-virtual {v3, p1, v4}, Landroidx/media3/common/util/GlProgram;->setFloatsUniform(Ljava/lang/String;[F)V

    .line 507
    iget-object p1, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->glProgram:Landroidx/media3/common/util/GlProgram;
...
.method synthetic constructor <init>(Landroid/content/Context;ZLandroidx/media3/inspector/frame/FrameExtractorInternal;Landroidx/media3/inspector/frame/FrameExtractorInternal$1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/media3/common/VideoFrameProcessingException;
...
.method private ensureConfigured(Landroidx/media3/common/GlObjectsProvider;II)V
    ...
    .line 614
    iget-object v0, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->hlgTextureInfo:Landroidx/media3/common/GlTextureInfo;
    ...
    iput-object p1, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->hlgTextureInfo:Landroidx/media3/common/GlTextureInfo;
    :try_end_0
    .catch Landroidx/media3/common/util/GlUtil$GlException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, p2}, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->onError(Ljava/lang/Exception;)V
...
.method public queueInputFrame(Landroidx/media3/common/GlObjectsProvider;Landroidx/media3/common/GlTextureInfo;J)V
    ...
    invoke-direct {p0, p1, v0, v1}, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->ensureConfigured(Landroidx/media3/common/GlObjectsProvider;II)V
    ...
    iget-object p1, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->hlgTextureInfo:Landroidx/media3/common/GlTextureInfo;
    ...
    iget-object v1, p0, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->hlgTextureInfo:Landroidx/media3/common/GlTextureInfo;
    ...
    .line 527
    invoke-virtual {p0, p1}, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->onError(Ljava/lang/Exception;)V
    ...
    .line 603
    invoke-virtual {p0}, Landroidx/media3/inspector/frame/FrameExtractorInternal$FrameReadingGlShaderProgram;->getInputListener()Landroidx/media3/effect/GlShaderProgram$InputListener;
