...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 275
    :try_start_0
    sget p0, Landroidx/gridlayout/widget/GridLayout;->ROW_COUNT:I
    ...
    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setRowCount(I)V

    .line 276
    sget p0, Landroidx/gridlayout/widget/GridLayout;->COLUMN_COUNT:I

    invoke-virtual {v7, p0, p1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setColumnCount(I)V

    .line 277
    sget p0, Landroidx/gridlayout/widget/GridLayout;->ORIENTATION:I

    invoke-virtual {v7, p0, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setOrientation(I)V

    .line 278
    sget p0, Landroidx/gridlayout/widget/GridLayout;->USE_DEFAULT_MARGINS:I

    invoke-virtual {v7, p0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setUseDefaultMargins(Z)V

    .line 279
    sget p0, Landroidx/gridlayout/widget/GridLayout;->ALIGNMENT_MODE:I

    invoke-virtual {v7, p0, v1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setAlignmentMode(I)V

    .line 280
    sget p0, Landroidx/gridlayout/widget/GridLayout;->ROW_ORDER_PRESERVED:I

    invoke-virtual {v7, p0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setRowOrderPreserved(Z)V

    .line 281
    sget p0, Landroidx/gridlayout/widget/GridLayout;->COLUMN_ORDER_PRESERVED:I

    invoke-virtual {v7, p0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    invoke-virtual {v3, p0}, Landroidx/gridlayout/widget/GridLayout;->setColumnOrderPreserved(Z)V
    :try_end_0
...
.method private isLayoutRtlCompat()Z
    ...
    .line 662
    invoke-virtual {p0}, Landroidx/gridlayout/widget/GridLayout;->getLayoutDirection()I
...
.method private measureChildrenWithMargins(IIZ)V
    ...
    .line 895
    iget p1, p0, Landroidx/gridlayout/widget/GridLayout;->mOrientation:I
    ...
    .line 896
    iget-object p2, v3, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->columnSpec:Landroidx/gridlayout/widget/GridLayout$Spec;

    goto :goto_2

    :cond_3
    iget-object p2, v3, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->rowSpec:Landroidx/gridlayout/widget/GridLayout$Spec;

    .line 897
    :goto_2
    invoke-virtual {p2, p1}, Landroidx/gridlayout/widget/GridLayout$Spec;->getAbsoluteAlignment(Z)Landroidx/gridlayout/widget/GridLayout$Alignment;
    ...
    .line 901
    iget v8, p2, Landroidx/gridlayout/widget/GridLayout$Interval;->max:I
    ...
    .line 902
    invoke-direct {p0, v4, p1}, Landroidx/gridlayout/widget/GridLayout;->getTotalMargin(Landroid/view/View;Z)I
    ...
    .line 906
    :cond_5
    iget p1, v3, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->width:I
...
.method getMargin1(Landroid/view/View;ZZ)I
    ...
    .line 656
    iget p2, v0, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->leftMargin:I

    goto :goto_0

    :cond_0
    iget p2, v0, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->rightMargin:I
    ...
    .line 657
    iget p2, v0, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->topMargin:I

    goto :goto_0

    :cond_2
    iget p2, v0, Landroidx/gridlayout/widget/GridLayout$LayoutParams;->bottomMargin:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 994
    invoke-virtual {v1}, Landroidx/gridlayout/widget/GridLayout;->getPaddingLeft()I

    move-result v7

    .line 995
    invoke-virtual {v1}, Landroidx/gridlayout/widget/GridLayout;->getPaddingTop()I

    move-result v8

    .line 996
    invoke-virtual {v1}, Landroidx/gridlayout/widget/GridLayout;->getPaddingRight()I

    move-result v9

    .line 997
    invoke-virtual {v1}, Landroidx/gridlayout/widget/GridLayout;->getPaddingBottom()I
    ...
    .line 1006
    invoke-virtual {v1, v14}, Landroidx/gridlayout/widget/GridLayout;->getChildAt(I)Landroid/view/View;
