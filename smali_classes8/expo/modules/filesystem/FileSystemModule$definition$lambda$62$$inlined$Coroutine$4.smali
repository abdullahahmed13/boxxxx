...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;[Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance p0, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$$inlined$Coroutine$4;

    invoke-direct {p0, p3}, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$$inlined$Coroutine$4;-><init>(Lkotlin/coroutines/Continuation;)V

    iput-object p2, p0, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$$inlined$Coroutine$4;->L$0:Ljava/lang/Object;

    sget-object p1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p0, p1}, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$$inlined$Coroutine$4;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$$inlined$Coroutine$4;->L$0:Ljava/lang/Object;

    check-cast p0, Lexpo/modules/filesystem/DownloadOptions;
    ...
    .line 271
    sget-object v7, Lexpo/modules/kotlin/services/FilePermissionService$Permission;->WRITE:Lexpo/modules/kotlin/services/FilePermissionService$Permission;

    invoke-virtual {v5, v7}, Lexpo/modules/filesystem/FileSystemPath;->validatePermission(Lexpo/modules/kotlin/services/FilePermissionService$Permission;)V
    ...
    invoke-direct {p0, v9, v4}, Lkotlinx/coroutines/CancellableContinuationImpl;-><init>(Lkotlin/coroutines/Continuation;I)V
    ...
    .line 292
    new-instance v10, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$lambda$8$$inlined$await$1;

    invoke-direct {v10, v9}, Lexpo/modules/filesystem/FileSystemModule$definition$lambda$62$lambda$8$$inlined$await$1;-><init>(Lkotlinx/coroutines/CancellableContinuation;)V
    ...
    invoke-interface {v7, v10}, Lokhttp3/Call;->enqueue(Lokhttp3/Callback;)V
    ...
    invoke-static {v0, v5, v6}, Landroid/webkit/URLUtil;->guessFileName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 307
    instance-of v5, v1, Lexpo/modules/filesystem/FileSystemDirectory;
    ...
    .line 313
    invoke-virtual {p0}, Lexpo/modules/filesystem/DownloadOptions;->getIdempotent()Z
    ...
    invoke-static {p1, v1, v3, v2, v4}, Lkotlin/io/ByteStreamsKt;->copyTo$default(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
    :try_end_1
    ...
    .line 317
    :cond_7
    new-instance p0, Lexpo/modules/filesystem/UnableToDownloadException;

    const-string p1, "response body is null"

    invoke-direct {p0, p1}, Lexpo/modules/filesystem/UnableToDownloadException;-><init>(Ljava/lang/String;)V

    throw p0

    .line 314
    :cond_8
    new-instance p0, Lexpo/modules/filesystem/DestinationAlreadyExistsException;

    invoke-direct {p0}, Lexpo/modules/filesystem/DestinationAlreadyExistsException;-><init>()V
    ...
    const-string v1, "response has status: "
