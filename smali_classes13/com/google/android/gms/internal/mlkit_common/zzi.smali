...
.method public static zza(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    .line 6
    invoke-static {v0, p1, v3}, Lcom/microsoft/intune/mam/client/content/MAMContentResolverManagement;->openAssetFileDescriptor(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
...
.method public static zzb(Landroid/content/Context;Landroid/net/Uri;Lcom/google/android/gms/internal/mlkit_common/zzh;)Ljava/io/InputStream;
    ...
    .line 5
    invoke-static {v0, p1}, Lcom/microsoft/intune/mam/client/content/MAMContentResolverManagement;->openInputStream(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-static {v0, v1, v2}, Lcom/microsoft/intune/mam/client/content/MAMContentResolverManagement;->openFileDescriptor(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method private static zzj(Landroid/content/Context;Landroid/net/Uri;ILcom/google/android/gms/internal/mlkit_common/zzh;)Z
    ...
    invoke-static {v0, p2, v1}, Lcom/microsoft/intune/mam/client/content/pm/MAMPackageManagement;->resolveContentProvider(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/ProviderInfo;
