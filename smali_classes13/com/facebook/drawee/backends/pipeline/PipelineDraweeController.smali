...
.method protected createDrawable(Lcom/facebook/common/references/CloseableReference;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    :try_start_2
    iget-object p0, p0, Lcom/facebook/drawee/backends/pipeline/PipelineDraweeController;->mDefaultDrawableFactory:Lcom/facebook/imagepipeline/drawable/DrawableFactory;

    invoke-interface {p0, p1}, Lcom/facebook/imagepipeline/drawable/DrawableFactory;->createDrawable(Lcom/facebook/imagepipeline/image/CloseableImage;)Landroid/graphics/drawable/Drawable;
...
.method protected getCacheKey()Lcom/facebook/cache/common/CacheKey;
    ...
    .line 218
    iget-object p0, p0, Lcom/facebook/drawee/backends/pipeline/PipelineDraweeController;->mCacheKey:Lcom/facebook/cache/common/CacheKey;
...
.method protected getCachedImage()Lcom/facebook/common/references/CloseableReference;
    ...
    .line 397
    :cond_1
    invoke-interface {v0, p0}, Lcom/facebook/imagepipeline/cache/MemoryCache;->get(Ljava/lang/Object;)Lcom/facebook/common/references/CloseableReference;
...
.method protected getDataSource()Lcom/facebook/datasource/DataSource;
    ...
    .line 245
    :cond_1
    iget-object p0, p0, Lcom/facebook/drawee/backends/pipeline/PipelineDraweeController;->mDataSourceSupplier:Lcom/facebook/common/internal/Supplier;
...
.method protected getImageInfo(Lcom/facebook/common/references/CloseableReference;)Lcom/facebook/imagepipeline/image/ImageInfo;
    ...
    invoke-static {p0}, Lcom/facebook/common/internal/Preconditions;->checkState(Z)V
    ...
    invoke-interface {p0}, Lcom/facebook/imagepipeline/image/CloseableImage;->getImageInfo()Lcom/facebook/imagepipeline/image/ImageInfo;
...
.method protected getMainUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lcom/facebook/drawee/backends/pipeline/PipelineDraweeController;->mFirstAvailableImageRequests:[Lcom/facebook/imagepipeline/request/ImageRequest;

    sget-object v2, Lcom/facebook/imagepipeline/request/ImageRequest;->REQUEST_TO_URI_FN:Lcom/facebook/common/internal/Fn;

    invoke-static {v0, v1, p0, v2}, Lcom/facebook/fresco/ui/common/MultiUriHelper;->getMainUri(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;Lcom/facebook/common/internal/Fn;)Landroid/net/Uri;
...
.method public isSameImageRequest(Lcom/facebook/drawee/interfaces/DraweeController;)Z
    ...
    invoke-static {p0, p1}, Lcom/facebook/common/internal/Objects;->equal(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method protected releaseDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 382
    instance-of p0, p1, Lcom/facebook/drawable/base/DrawableWithCaches;
...
.method protected updateDebugOverlay(Lcom/facebook/imagepipeline/image/CloseableImage;Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;)V
    ...
    invoke-virtual {p2, v0, p0}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->addAdditionalData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p0, v0}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->setDimensions(II)V
    ...
    invoke-virtual {p2, p0}, Lcom/facebook/drawee/debug/DebugControllerOverlayDrawable;->setImageSize(I)V
