...
.method protected getResult()Lcom/facebook/common/references/CloseableReference;
    ...
    invoke-static {v3, v0, v2}, Landroid/media/ThumbnailUtils;->createVideoThumbnail(Ljava/io/File;Landroid/util/Size;Landroid/os/CancellationSignal;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v0, v2}, Landroid/media/ThumbnailUtils;->createImageThumbnail(Ljava/io/File;Landroid/util/Size;Landroid/os/CancellationSignal;)Landroid/graphics/Bitmap;
    ...
    .line 101
    invoke-static {v2, v3, v0, v4}, Lcom/microsoft/intune/mam/client/content/MAMContentResolverManagement;->loadThumbnail(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/util/Size;Landroid/os/CancellationSignal;)Landroid/graphics/Bitmap;
    ...
    .line 110
    invoke-static {v2, v0, v1, v3}, Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;->of(Landroid/graphics/Bitmap;Lcom/facebook/common/references/ResourceReleaser;Lcom/facebook/imagepipeline/image/QualityInfo;I)Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;
    ...
    .line 116
    iget-object p0, p0, Lcom/facebook/imagepipeline/producers/LocalThumbnailBitmapSdk29Producer$1;->val$context:Lcom/facebook/imagepipeline/producers/ProducerContext;

    invoke-interface {p0}, Lcom/facebook/imagepipeline/producers/ProducerContext;->getExtras()Ljava/util/Map;

    move-result-object p0

    invoke-interface {v0, p0}, Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;->putExtras(Ljava/util/Map;)V
...
.method protected onCancellation()V
    ...
    .line 123
    iget-object p0, p0, Lcom/facebook/imagepipeline/producers/LocalThumbnailBitmapSdk29Producer$1;->val$cancellationSignal:Landroid/os/CancellationSignal;
...
.method protected onFailure(Ljava/lang/Exception;)V
    ...
    const-string/jumbo v0, "thumbnail_bitmap"

    invoke-interface {p0, p1, v0}, Lcom/facebook/imagepipeline/producers/ProducerContext;->putOriginExtra(Ljava/lang/String;Ljava/lang/String;)V
