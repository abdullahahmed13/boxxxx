...
.method protected decodeByteArrayAsPurgeable(Lcom/facebook/common/references/CloseableReference;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 54
    iget-object p0, p0, Lcom/facebook/imagepipeline/platform/KitKatPurgeableDecoder;->mFlexByteArrayPool:Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;

    invoke-virtual {p0, v0}, Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;->get(I)Lcom/facebook/common/references/CloseableReference;
    ...
    .line 57
    invoke-interface {p1, v2, v1, v2, v0}, Lcom/facebook/common/memory/PooledByteBuffer;->read(I[BII)I
...
.method protected decodeJPEGByteArrayAsPurgeable(Lcom/facebook/common/references/CloseableReference;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v1}, Lcom/facebook/imagepipeline/memory/FlexByteArrayPool;->get(I)Lcom/facebook/common/references/CloseableReference;
    ...
    .line 83
    invoke-interface {p1, v2, v3, v2, p2}, Lcom/facebook/common/memory/PooledByteBuffer;->read(I[BII)I

    if-eqz v0, :cond_2

    .line 85
    invoke-static {v3, p2}, Lcom/facebook/imagepipeline/platform/KitKatPurgeableDecoder;->putEOI([BI)V
