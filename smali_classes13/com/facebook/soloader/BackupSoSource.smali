...
.method private addBackupsFromSplitApks(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 78
    const-string p1, "failed to read split apks"
...
.method protected getDepsBlock()[B
    ...
    .line 172
    :cond_0
    iget-object p0, p0, Lcom/facebook/soloader/BackupSoSource;->mContext:Landroid/content/Context;
...
.method public getDsosBaseApk()[Lcom/facebook/soloader/UnpackingSoSource$Dso;
    ...
    check-cast p0, Lcom/facebook/soloader/ExtractFromZipSoSource;

    invoke-virtual {p0}, Lcom/facebook/soloader/ExtractFromZipSoSource;->makeUnpacker()Lcom/facebook/soloader/UnpackingSoSource$Unpacker;
...
.method public recover(Landroid/content/Context;)Lcom/facebook/soloader/SoSource;
    ...
    iget-object p0, p0, Lcom/facebook/soloader/BackupSoSource;->soDirectory:Ljava/io/File;

    invoke-virtual {p0}, Ljava/io/File;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-direct {v0, p1, p0}, Lcom/facebook/soloader/BackupSoSource;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const/4 p0, 0x0

    .line 197
    :try_start_0
    invoke-virtual {v0, p0}, Lcom/facebook/soloader/BackupSoSource;->prepare(I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
