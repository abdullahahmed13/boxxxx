...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, p0}, Lcom/facebook/soloader/recovery/BaseApkPathHistory;->recordPathIfNew(Ljava/lang/String;)Z
...
.method public get()Lcom/facebook/soloader/recovery/RecoveryStrategy;
    ...
    iget p0, p0, Lcom/facebook/soloader/recovery/DefaultRecoveryStrategyFactory;->mRecoveryFlags:I

    invoke-direct {v2, p0}, Lcom/facebook/soloader/recovery/ReunpackBackupSoSources;-><init>(I)V

    const/4 p0, 0x4

    aput-object v2, v1, p0

    new-instance p0, Lcom/facebook/soloader/recovery/CheckOnDiskStateDataData;

    invoke-direct {p0}, Lcom/facebook/soloader/recovery/CheckOnDiskStateDataData;-><init>()V

    const/4 v2, 0x5

    aput-object p0, v1, v2

    new-instance p0, Lcom/facebook/soloader/recovery/ReunpackNonBackupSoSources;

    invoke-direct {p0}, Lcom/facebook/soloader/recovery/ReunpackNonBackupSoSources;-><init>()V

    const/4 v2, 0x6

    aput-object p0, v1, v2

    new-instance p0, Lcom/facebook/soloader/recovery/WaitForAsyncInit;

    invoke-direct {p0}, Lcom/facebook/soloader/recovery/WaitForAsyncInit;-><init>()V
