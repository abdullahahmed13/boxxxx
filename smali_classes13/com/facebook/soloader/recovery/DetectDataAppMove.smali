...
.method private detectMove()Z
    ...
    iget-object p0, p0, Lcom/facebook/soloader/recovery/DetectDataAppMove;->mBaseApkPathHistory:Lcom/facebook/soloader/recovery/BaseApkPathHistory;

    invoke-virtual {p0, v0}, Lcom/facebook/soloader/recovery/BaseApkPathHistory;->recordPathIfNew(Ljava/lang/String;)Z
...
.method private getBaseApkPath()Ljava/lang/String;
    ...
    .line 68
    iget-object p0, p0, Lcom/facebook/soloader/recovery/DetectDataAppMove;->mContext:Landroid/content/Context;
...
.method public recover(Ljava/lang/UnsatisfiedLinkError;[Lcom/facebook/soloader/SoSource;)Z
    ...
    invoke-virtual {p0}, Lcom/facebook/soloader/recovery/BaseApkPathHistory;->size()I
    ...
    .line 46
    const-string/jumbo p0, "soloader.recovery.DetectDataAppMove"
