...
.method public recover(Ljava/lang/UnsatisfiedLinkError;[Lcom/facebook/soloader/SoSource;)Z
    ...
    const-string/jumbo p1, "soloader.recovery.CheckBaseApkExists"

    invoke-static {p1, p0}, Lcom/facebook/soloader/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 48
    iget-object p0, p0, Lcom/facebook/soloader/recovery/CheckBaseApkExists;->mBaseApkPathHistory:Lcom/facebook/soloader/recovery/BaseApkPathHistory;

    invoke-virtual {p0, p2}, Lcom/facebook/soloader/recovery/BaseApkPathHistory;->report(Ljava/lang/StringBuilder;)V
