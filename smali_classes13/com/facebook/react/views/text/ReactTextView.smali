...
.method public getSpanned()Landroid/text/Spannable;
    ...
    .line 714
    iget-object p0, p0, Lcom/facebook/react/views/text/ReactTextView;->mSpanned:Landroid/text/Spannable;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 340
    new-instance v1, Lcom/facebook/react/internal/SystraceSection;

    const-string v2, "ReactTextView.onDraw"

    invoke-direct {v1, v2}, Lcom/facebook/react/internal/SystraceSection;-><init>(Ljava/lang/String;)V

    .line 341
    :try_start_0
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getSpanned()Landroid/text/Spannable;

    move-result-object v3

    .line 342
    iget-boolean v2, v0, Lcom/facebook/react/views/text/ReactTextView;->mAdjustsFontSizeToFit:Z

    if-eqz v2, :cond_0

    if-eqz v3, :cond_0

    iget-boolean v2, v0, Lcom/facebook/react/views/text/ReactTextView;->mShouldAdjustSpannableFontSize:Z
    ...
    .line 343
    iput-boolean v2, v0, Lcom/facebook/react/views/text/ReactTextView;->mShouldAdjustSpannableFontSize:Z

    .line 346
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getWidth()I
    ...
    .line 348
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getHeight()I
    ...
    iget v8, v0, Lcom/facebook/react/views/text/ReactTextView;->mMinimumFontSize:F

    iget v9, v0, Lcom/facebook/react/views/text/ReactTextView;->mNumberOfLines:I

    .line 352
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getIncludeFontPadding()Z

    move-result v10

    .line 353
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getBreakStrategy()I

    move-result v11

    .line 354
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getHyphenationFrequency()I
    ...
    .line 358
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getJustificationMode()I

    move-result v14

    .line 359
    invoke-virtual {v0}, Lcom/facebook/react/views/text/ReactTextView;->getPaint()Landroid/text/TextPaint;
    ...
    .line 360
    invoke-virtual {v0, v3}, Lcom/facebook/react/views/text/ReactTextView;->setText(Ljava/lang/CharSequence;)V

    .line 363
    :cond_0
    iget-object v2, v0, Lcom/facebook/react/views/text/ReactTextView;->mOverflow:Lcom/facebook/react/uimanager/style/Overflow;
    ...
    .line 368
    invoke-virtual {v1}, Lcom/facebook/react/internal/SystraceSection;->close()V
...
.method public reactTagForTouch(FF)I
    ...
    .line 466
    const-class p1, Lcom/facebook/react/views/text/internal/span/ReactTagSpan;

    invoke-interface {v2, p0, p0, p1}, Landroid/text/Spanned;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lcom/facebook/react/views/text/internal/span/ReactTagSpan;
    ...
    invoke-virtual {p2}, Lcom/facebook/react/views/text/internal/span/ReactTagSpan;->getReactTag()I
