...
.method public getReloadAndProfileConfig()Lcom/facebook/react/bridge/WritableMap;
    ...
    .line 45
    sget-object v0, Lcom/facebook/react/modules/devtoolsruntimesettings/ReactDevToolsRuntimeSettingsModule;->settings:Lcom/facebook/react/modules/devtoolsruntimesettings/Settings;

    invoke-virtual {v0}, Lcom/facebook/react/modules/devtoolsruntimesettings/Settings;->getShouldReloadAndProfile()Z

    move-result v1

    const-string/jumbo v2, "shouldReloadAndProfile"

    invoke-interface {p0, v2, v1}, Lcom/facebook/react/bridge/WritableMap;->putBoolean(Ljava/lang/String;Z)V

    .line 46
    const-string/jumbo v1, "recordChangeDescriptions"

    invoke-virtual {v0}, Lcom/facebook/react/modules/devtoolsruntimesettings/Settings;->getRecordChangeDescriptions()Z
...
.method public setReloadAndProfileConfig(Lcom/facebook/react/bridge/ReadableMap;)V
    ...
    .line 35
    const-string/jumbo p0, "shouldReloadAndProfile"
    ...
    invoke-virtual {v0, p0}, Lcom/facebook/react/modules/devtoolsruntimesettings/Settings;->setShouldReloadAndProfile(Z)V

    .line 38
    :cond_0
    const-string/jumbo p0, "recordChangeDescriptions"
    ...
    invoke-virtual {v0, p0}, Lcom/facebook/react/modules/devtoolsruntimesettings/Settings;->setRecordChangeDescriptions(Z)V
