...
.method private final getCallerContext()Ljava/lang/Object;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lcom/facebook/react/modules/image/ImageLoaderModule;->callerContext:Ljava/lang/Object;
...
.method private final getImagePipeline()Lcom/facebook/imagepipeline/core/ImagePipeline;
    ...
    .line 48
    iget-object p0, p0, Lcom/facebook/react/modules/image/ImageLoaderModule;->_imagePipeline:Lcom/facebook/imagepipeline/core/ImagePipeline;
    ...
    const-string v0, "getImagePipeline(...)"
...
.method private final registerRequest(ILcom/facebook/datasource/DataSource;)V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/facebook/react/modules/image/ImageLoaderModule;->enqueuedRequests:Landroid/util/SparseArray;
...
.method public getSize(Ljava/lang/String;Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 89
    new-instance p1, Lcom/facebook/react/modules/image/ImageLoaderModule$getSize$dataSubscriber$1;

    invoke-direct {p1, p2}, Lcom/facebook/react/modules/image/ImageLoaderModule$getSize$dataSubscriber$1;-><init>(Lcom/facebook/react/bridge/Promise;)V
    ...
    :cond_1
    :goto_0
    const-string p0, "E_INVALID_URI"

    const-string p1, "Cannot get the size of an image for an empty URI"
...
.method public getSizeWithHeaders(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/Promise;)V
    ...
    const-string/jumbo p1, "newBuilderWithSource(...)"
    ...
    .line 142
    new-instance p1, Lcom/facebook/react/modules/image/ImageLoaderModule$getSizeWithHeaders$dataSubscriber$1;

    invoke-direct {p1, p3}, Lcom/facebook/react/modules/image/ImageLoaderModule$getSizeWithHeaders$dataSubscriber$1;-><init>(Lcom/facebook/react/bridge/Promise;)V
...
.method public prefetchImage(Ljava/lang/String;DLcom/facebook/react/bridge/Promise;)V
    ...
    invoke-interface {p1, p3, p0}, Lcom/facebook/datasource/DataSource;->subscribe(Lcom/facebook/datasource/DataSubscriber;Ljava/util/concurrent/Executor;)V
    ...
    const-string p1, "Cannot prefetch an image for an empty URI"

    invoke-interface {p4, p0, p1}, Lcom/facebook/react/bridge/Promise;->reject(Ljava/lang/String;Ljava/lang/String;)V
...
.method public queryCache(Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 248
    sget-object p0, Lcom/facebook/react/bridge/GuardedAsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    const/4 p1, 0x0

    new-array p1, p1, [Ljava/lang/Void;

    invoke-virtual {v1, p0, p1}, Lcom/facebook/react/modules/image/ImageLoaderModule$queryCache$1;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
