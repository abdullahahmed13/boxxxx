...
.method private final getWebSocketModule()Lcom/facebook/react/modules/websocket/WebSocketModule;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/react/bridge/ReactApplicationContext;->getNativeModule(Ljava/lang/Class;)Lcom/facebook/react/bridge/NativeModule;

    move-result-object p0

    check-cast p0, Lcom/facebook/react/modules/websocket/WebSocketModule;
...
.method public addNetworkingHandler()V
    ...
    .line 279
    iget-object p0, p0, Lcom/facebook/react/modules/blob/BlobModule;->networkingResponseHandler:Lcom/facebook/react/modules/blob/BlobModule$networkingResponseHandler$1;

    check-cast p0, Lcom/facebook/react/modules/network/NetworkingModule$ResponseHandler;

    invoke-virtual {v0, p0}, Lcom/facebook/react/modules/network/NetworkingModule;->addResponseHandler$ReactAndroid_release(Lcom/facebook/react/modules/network/NetworkingModule$ResponseHandler;)V
...
.method public addWebSocketHandler(D)V
    ...
    iget-object p0, p0, Lcom/facebook/react/modules/blob/BlobModule;->webSocketContentHandler:Lcom/facebook/react/modules/blob/BlobModule$webSocketContentHandler$1;

    check-cast p0, Lcom/facebook/react/modules/websocket/WebSocketModule$ContentHandler;

    invoke-virtual {p2, p1, p0}, Lcom/facebook/react/modules/websocket/WebSocketModule;->setContentHandler(ILcom/facebook/react/modules/websocket/WebSocketModule$ContentHandler;)V
...
.method public final getLengthOfBlob(Ljava/lang/String;)J
    ...
    .line 159
    :try_start_0
    iget-object p0, p0, Lcom/facebook/react/modules/blob/BlobModule;->blobs:Ljava/util/HashMap;
...
.method public removeWebSocketHandler(D)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/facebook/react/modules/websocket/WebSocketModule;->setContentHandler(ILcom/facebook/react/modules/websocket/WebSocketModule$ContentHandler;)V
...
.method public sendOverSocket(Lcom/facebook/react/bridge/ReadableMap;D)V
    ...
    invoke-virtual {p1, p0}, Lokio/ByteString$Companion;->-deprecated_of(Ljava/nio/ByteBuffer;)Lokio/ByteString;

    move-result-object p0

    invoke-virtual {p3, p0, p2}, Lcom/facebook/react/modules/websocket/WebSocketModule;->sendBinary(Lokio/ByteString;I)V
