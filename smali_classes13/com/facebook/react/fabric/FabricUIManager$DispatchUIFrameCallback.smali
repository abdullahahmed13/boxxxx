...
.method public doFrameGuarded(J)V
    ...
    const-string p1, "Not flushing pending UI operations: exception was previously thrown"
    ...
    const-string p1, "Not flushing pending UI operations: FabricUIManager is destroyed"
    ...
    .line 1508
    iget-object p0, p0, Lcom/facebook/react/fabric/FabricUIManager$DispatchUIFrameCallback;->this$0:Lcom/facebook/react/fabric/FabricUIManager;

    invoke-static {p0}, Lcom/facebook/react/fabric/FabricUIManager;->-$$Nest$fgetmSynchronousEvents(Lcom/facebook/react/fabric/FabricUIManager;)Ljava/util/Set;
