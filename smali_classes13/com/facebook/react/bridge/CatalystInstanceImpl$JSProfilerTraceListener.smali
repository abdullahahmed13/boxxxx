...
.method public onTraceStarted()V
    ...
    .line 645
    iget-object p0, p0, Lcom/facebook/react/bridge/CatalystInstanceImpl$JSProfilerTraceListener;->mOuter:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0, v0}, Lcom/facebook/react/bridge/CatalystInstanceImpl;->getJSModule(Ljava/lang/Class;)Lcom/facebook/react/bridge/JavaScriptModule;

    move-result-object p0

    check-cast p0, Lcom/facebook/react/bridge/Systrace;

    const/4 v0, 0x1

    invoke-interface {p0, v0}, Lcom/facebook/react/bridge/Systrace;->setEnabled(Z)V
