...
.method private final createColorMatrixEffect(Landroid/graphics/ColorMatrix;Landroid/graphics/RenderEffect;)Landroid/graphics/RenderEffect;
    ...
    invoke-static {p0, p2}, Landroid/graphics/RenderEffect;->createColorFilterEffect(Landroid/graphics/ColorFilter;Landroid/graphics/RenderEffect;)Landroid/graphics/RenderEffect;
...
.method private final createGrayscaleColorMatrix(F)Landroid/graphics/ColorMatrix;
    ...
    const v7, 0x3e91d14e    # 0.2848f

    mul-float/2addr v7, v0

    add-float/2addr v7, v3

    const v3, 0x3f6d844d    # 0.9278f
...
.method private final createHueRotateColorMatrix(F)Landroid/graphics/ColorMatrix;
    ...
    .line 333
    invoke-direct {p1, p0}, Landroid/graphics/ColorMatrix;-><init>([F)V
...
.method private final createSepiaColorMatrix(F)Landroid/graphics/ColorMatrix;
    ...
    const v9, 0x3f5e76c9    # 0.869f

    mul-float/2addr v0, v9

    const v9, 0x3e0624dd    # 0.131f
    ...
    .line 287
    invoke-direct {p1, v9}, Landroid/graphics/ColorMatrix;-><init>([F)V
...
.method public static final parseColorMatrixFilters(Lcom/facebook/react/bridge/ReadableArray;)Landroid/graphics/ColorMatrixColorFilter;
    ...
    const-string/jumbo v5, "null cannot be cast to non-null type kotlin.Double"
...
.method public static final parseFilters(Lcom/facebook/react/bridge/ReadableArray;)Landroid/graphics/RenderEffect;
    ...
    const-string/jumbo v5, "null cannot be cast to non-null type com.facebook.react.bridge.ReadableMap"
...
.method public final createBlurEffect(FLandroid/graphics/RenderEffect;)Landroid/graphics/RenderEffect;
    ...
    invoke-static {p0, p0, p2, p1}, Landroid/graphics/RenderEffect;->createBlurEffect(FFLandroid/graphics/RenderEffect;Landroid/graphics/Shader$TileMode;)Landroid/graphics/RenderEffect;
...
.method public final createDropShadowEffect(FFFILandroid/graphics/RenderEffect;)Landroid/graphics/RenderEffect;
    ...
    .line 161
    const-string p0, "createOffsetEffect(...)"
    ...
    invoke-direct {p0, p4, p2}, Landroid/graphics/BlendModeColorFilter;-><init>(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p3, p3, p0, p1}, Landroid/graphics/RenderEffect;->createBlurEffect(FFLandroid/graphics/RenderEffect;Landroid/graphics/Shader$TileMode;)Landroid/graphics/RenderEffect;

    move-result-object p0

    const-string p1, "createBlurEffect(...)"
    ...
    invoke-static {p0, p5, p1}, Landroid/graphics/RenderEffect;->createBlendModeEffect(Landroid/graphics/RenderEffect;Landroid/graphics/RenderEffect;Landroid/graphics/BlendMode;)Landroid/graphics/RenderEffect;
...
.method public final createOpacityColorMatrix(F)Landroid/graphics/ColorMatrix;
    ...
    .line 208
    invoke-virtual {p0, v0, v0, v0, p1}, Landroid/graphics/ColorMatrix;->setScale(FFFF)V
...
.method public final parseAndCreateDropShadowEffect(Lcom/facebook/react/bridge/ReadableMap;Landroid/graphics/RenderEffect;)Landroid/graphics/RenderEffect;
    ...
    .line 199
    const-string/jumbo v0, "standardDeviation"
