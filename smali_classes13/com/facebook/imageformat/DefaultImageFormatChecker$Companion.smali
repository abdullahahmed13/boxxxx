...
.method public static final synthetic access$isAvifHeader(Lcom/facebook/imageformat/DefaultImageFormatChecker$Companion;[BI)Z
    .locals 0

    .line 80
    invoke-direct {p0, p1, p2}, Lcom/facebook/imageformat/DefaultImageFormatChecker$Companion;->isAvifHeader([BI)Z
...
.method private final getBoxLength([B)I
    .locals 1
...
.method private final getWebpFormat([BI)Lcom/facebook/imageformat/ImageFormat;
    ...
    .line 93
    invoke-static {p1, p0}, Lcom/facebook/common/webp/WebpSupportStatus;->isSimpleWebpHeader([BI)Z
    ...
    .line 96
    :cond_0
    invoke-static {p1, p0}, Lcom/facebook/common/webp/WebpSupportStatus;->isLosslessWebpHeader([BI)Z
    ...
    .line 99
    :cond_1
    invoke-static {p1, p0, p2}, Lcom/facebook/common/webp/WebpSupportStatus;->isExtendedWebpHeader([BII)Z
    ...
    .line 100
    invoke-static {p1, p0}, Lcom/facebook/common/webp/WebpSupportStatus;->isAnimatedWebpHeader([BI)Z
    ...
    .line 103
    :cond_2
    invoke-static {p1, p0}, Lcom/facebook/common/webp/WebpSupportStatus;->isExtendedWebpHeaderWithAlpha([BI)Z
...
.method private final isAvifHeader([BI)Z
    .locals 2
    ...
    .line 329
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imageformat/DefaultImageFormatChecker$Companion;->getBoxLength([B)I
    ...
    .line 333
    :cond_1
    invoke-static {}, Lcom/facebook/imageformat/DefaultImageFormatChecker;->access$getAVIF_HEADER_PREFIX$cp()[B

    move-result-object p0

    const/4 v0, 0x4

    invoke-static {p1, p0, v0}, Lcom/facebook/imageformat/ImageFormatCheckerUtils;->hasPatternAt([B[BI)Z
    ...
    .line 336
    :cond_2
    invoke-static {}, Lcom/facebook/imageformat/DefaultImageFormatChecker;->access$getAVIF_HEADER_SUFFIX$cp()[B

    move-result-object p0

    invoke-static {p1, p0, p2}, Lcom/facebook/imageformat/ImageFormatCheckerUtils;->hasPatternAt([B[BI)Z
...
.method private final isBinaryXmlHeader([BI)Z
    ...
    invoke-static {p1, p0}, Lcom/facebook/imageformat/ImageFormatCheckerUtils;->startsWithPattern([B[B)Z
...
.method private final isHeifHeader([BI)Z
    ...
    invoke-static {p1, p0, v1}, Lcom/facebook/imageformat/ImageFormatCheckerUtils;->hasPatternAt([B[BI)Z
    ...
    .line 260
    invoke-static {p1, v3, p2}, Lcom/facebook/imageformat/ImageFormatCheckerUtils;->hasPatternAt([B[BI)Z
