...
.method private shouldCreateNewStorage()Z
    ...
    .line 163
    iget-object p0, p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage;->mCurrentState:Lcom/facebook/cache/disk/DynamicDefaultDiskStorage$State;

    .line 164
    iget-object v0, p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage$State;->delegate:Lcom/facebook/cache/disk/DiskStorage;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage$State;->rootDirectory:Ljava/io/File;

    if-eqz v0, :cond_1

    iget-object p0, p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage$State;->rootDirectory:Ljava/io/File;
...
.method public clearAll()V
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->clearAll()V
...
.method public contains(Ljava/lang/String;Ljava/lang/Object;)Z
    ...
    invoke-interface {p0, p1, p2}, Lcom/facebook/cache/disk/DiskStorage;->contains(Ljava/lang/String;Ljava/lang/Object;)Z
...
.method createRootDirectoryIfNecessary(Ljava/io/File;)V
    ...
    .line 197
    sget-object p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage;->TAG:Ljava/lang/Class;
    ...
    invoke-static {p0, v0, p1}, Lcom/facebook/common/logging/FLog;->d(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 190
    iget-object p0, p0, Lcom/facebook/cache/disk/DynamicDefaultDiskStorage;->mCacheErrorLogger:Lcom/facebook/cache/common/CacheErrorLogger;
    ...
    invoke-interface {p0, v0, v1, v2, p1}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method deleteOldStorageIfNecessary()V
    ...
    invoke-static {p0}, Lcom/facebook/common/file/FileTree;->deleteRecursively(Ljava/io/File;)Z
...
.method public getEntries()Ljava/util/Collection;
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->getEntries()Ljava/util/Collection;
...
.method public getResource(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/binaryresource/BinaryResource;
    ...
    invoke-interface {p0, p1, p2}, Lcom/facebook/cache/disk/DiskStorage;->getResource(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/binaryresource/BinaryResource;
...
.method public getStorageName()Ljava/lang/String;
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->getStorageName()Ljava/lang/String;
...
.method public isExternal()Z
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->isExternal()Z
...
.method public purgeUnexpectedResources()V
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->purgeUnexpectedResources()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v1, "purgeUnexpectedResources"

    invoke-static {v0, v1, p0}, Lcom/facebook/common/logging/FLog;->e(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public remove(Lcom/facebook/cache/disk/DiskStorage$Entry;)J
    ...
    invoke-interface {p0, p1}, Lcom/facebook/cache/disk/DiskStorage;->remove(Lcom/facebook/cache/disk/DiskStorage$Entry;)J
...
.method public remove(Ljava/lang/String;)J
    ...
    invoke-interface {p0, p1}, Lcom/facebook/cache/disk/DiskStorage;->remove(Ljava/lang/String;)J
...
.method public touch(Ljava/lang/String;Ljava/lang/Object;)Z
    ...
    invoke-interface {p0, p1, p2}, Lcom/facebook/cache/disk/DiskStorage;->touch(Ljava/lang/String;Ljava/lang/Object;)Z
