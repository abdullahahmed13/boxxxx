...
.method private endInsert(Lcom/facebook/cache/disk/DiskStorage$Inserter;Lcom/facebook/cache/common/CacheKey;Ljava/lang/String;)Lcom/facebook/binaryresource/BinaryResource;
    ...
    .line 337
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mCacheStats:Lcom/facebook/cache/disk/DiskStorageCache$CacheStats;
    ...
    invoke-virtual {p0, p2, p3, v1, v2}, Lcom/facebook/cache/disk/DiskStorageCache$CacheStats;->increment(JJ)V
...
.method private evictAboveSize(JLcom/facebook/cache/common/CacheEventListener$EvictionReason;)V
    ...
    .line 495
    iget-object v1, v1, Lcom/facebook/cache/disk/DiskStorageCache;->mCacheErrorLogger:Lcom/facebook/cache/common/CacheErrorLogger;
...
.method private getSortedEntries(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    .line 551
    :cond_1
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mEntryEvictionComparatorSupplier:Lcom/facebook/cache/disk/EntryEvictionComparatorSupplier;

    invoke-interface {p0}, Lcom/facebook/cache/disk/EntryEvictionComparatorSupplier;->get()Lcom/facebook/cache/disk/EntryEvictionComparator;
...
.method private startInsert(Ljava/lang/String;Lcom/facebook/cache/common/CacheKey;)Lcom/facebook/cache/disk/DiskStorage$Inserter;
    ...
    .line 324
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mStorage:Lcom/facebook/cache/disk/DiskStorage;

    invoke-interface {p0, p1, p2}, Lcom/facebook/cache/disk/DiskStorage;->insert(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/cache/disk/DiskStorage$Inserter;
...
.method private trimBy(D)V
    ...
    .line 669
    :try_start_1
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mCacheErrorLogger:Lcom/facebook/cache/common/CacheErrorLogger;

    sget-object p2, Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;->EVICTION:Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;
    ...
    .line 669
    invoke-interface {p0, p2, v2, v0, p1}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected awaitIndex()V
    ...
    .line 221
    :catch_0
    sget-object p0, Lcom/facebook/cache/disk/DiskStorageCache;->TAG:Ljava/lang/Class;

    const-string v0, "Memory Index is not ready yet. "

    invoke-static {p0, v0}, Lcom/facebook/common/logging/FLog;->e(Ljava/lang/Class;Ljava/lang/String;)V
...
.method public clearAll()V
    ...
    invoke-virtual {p0}, Lcom/facebook/cache/disk/DiskStorageCache$CacheStats;->reset()V
...
.method public clearOldEntries(J)J
    ...
    .line 449
    invoke-interface {v1, v5, v6, v7, v0}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public getCount()J
    ...
    invoke-virtual {p0}, Lcom/facebook/cache/disk/DiskStorageCache$CacheStats;->getCount()J
...
.method public getDumpInfo()Lcom/facebook/cache/disk/DiskStorage$DiskDumpInfo;
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->getDumpInfo()Lcom/facebook/cache/disk/DiskStorage$DiskDumpInfo;
...
.method public getResource(Lcom/facebook/cache/common/CacheKey;)Lcom/facebook/binaryresource/BinaryResource;
    ...
    .line 276
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mCacheEventListener:Lcom/facebook/cache/common/CacheEventListener;

    if-eqz p0, :cond_5

    .line 277
    invoke-interface {p0, v0}, Lcom/facebook/cache/common/CacheEventListener;->onReadException(Lcom/facebook/cache/common/CacheEvent;)V
    :try_end_4
...
.method public getSize()J
    ...
    invoke-virtual {p0}, Lcom/facebook/cache/disk/DiskStorageCache$CacheStats;->getSize()J
...
.method public hasKey(Lcom/facebook/cache/common/CacheKey;)Z
    ...
    .line 628
    iget-object p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mResourceIndex:Ljava/util/Set;
...
.method public insert(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/cache/common/WriterCallback;)Lcom/facebook/binaryresource/BinaryResource;
    ...
    .line 376
    invoke-interface {p0, v0}, Lcom/facebook/cache/common/CacheEventListener;->onWriteException(Lcom/facebook/cache/common/CacheEvent;)V
    ...
    invoke-static {p0, p2, p1}, Lcom/facebook/common/logging/FLog;->e(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public isEnabled()Z
    ...
    invoke-interface {p0}, Lcom/facebook/cache/disk/DiskStorage;->isEnabled()Z
...
.method public isIndexReady()Z
    ...
    iget-boolean p0, p0, Lcom/facebook/cache/disk/DiskStorageCache;->mIndexPopulateAtStartupEnabled:Z
...
.method public probe(Lcom/facebook/cache/common/CacheKey;)Z
    ...
    .line 313
    invoke-interface {p0, p1}, Lcom/facebook/cache/common/CacheEventListener;->onReadException(Lcom/facebook/cache/common/CacheEvent;)V
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)V
    ...
    .line 397
    invoke-interface {p0, v1, v2, v3, p1}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
