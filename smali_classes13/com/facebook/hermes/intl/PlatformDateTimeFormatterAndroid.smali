...
.method public configure(Lcom/facebook/hermes/intl/ILocaleObject;Ljava/lang/String;Ljava/lang/String;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$FormatMatcher;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$WeekDay;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Era;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Year;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Month;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Day;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Hour;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Minute;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$Second;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$TimeZoneName;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$HourCycle;Ljava/lang/Object;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$DateStyle;Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$TimeStyle;Ljava/lang/Object;)V
    ...
    .line 205
    iget-object p0, p0, Lcom/facebook/hermes/intl/PlatformDateTimeFormatterAndroid;->mDateFormat:Ljava/text/DateFormat;
...
.method public fieldToString(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 29
    sget-object p0, Ljava/text/DateFormat$Field;->DAY_OF_WEEK:Ljava/text/DateFormat$Field;
    ...
    .line 32
    :cond_0
    sget-object p0, Ljava/text/DateFormat$Field;->ERA:Ljava/text/DateFormat$Field;
    ...
    .line 35
    :cond_1
    sget-object p0, Ljava/text/DateFormat$Field;->YEAR:Ljava/text/DateFormat$Field;
    ...
    .line 46
    :cond_2
    sget-object p0, Ljava/text/DateFormat$Field;->MONTH:Ljava/text/DateFormat$Field;
    ...
    .line 49
    :cond_3
    sget-object p0, Ljava/text/DateFormat$Field;->DAY_OF_MONTH:Ljava/text/DateFormat$Field;
    ...
    .line 52
    :cond_4
    sget-object p0, Ljava/text/DateFormat$Field;->HOUR0:Ljava/text/DateFormat$Field;
    ...
    .line 55
    :cond_5
    sget-object p0, Ljava/text/DateFormat$Field;->HOUR1:Ljava/text/DateFormat$Field;
    ...
    .line 58
    :cond_6
    sget-object p0, Ljava/text/DateFormat$Field;->HOUR_OF_DAY0:Ljava/text/DateFormat$Field;
    ...
    .line 61
    :cond_7
    sget-object p0, Ljava/text/DateFormat$Field;->HOUR_OF_DAY1:Ljava/text/DateFormat$Field;
    ...
    .line 64
    :cond_8
    sget-object p0, Ljava/text/DateFormat$Field;->MINUTE:Ljava/text/DateFormat$Field;
    ...
    .line 67
    :cond_9
    sget-object p0, Ljava/text/DateFormat$Field;->SECOND:Ljava/text/DateFormat$Field;
    ...
    .line 70
    :cond_a
    sget-object p0, Ljava/text/DateFormat$Field;->TIME_ZONE:Ljava/text/DateFormat$Field;
    ...
    .line 73
    :cond_b
    sget-object p0, Ljava/text/DateFormat$Field;->AM_PM:Ljava/text/DateFormat$Field;
...
.method public formatToParts(D)Ljava/text/AttributedCharacterIterator;
    ...
    invoke-virtual {p0, p1}, Ljava/text/DateFormat;->formatToCharacterIterator(Ljava/lang/Object;)Ljava/text/AttributedCharacterIterator;
...
.method public getDefaultHourCycle(Lcom/facebook/hermes/intl/ILocaleObject;)Lcom/facebook/hermes/intl/IPlatformDateTimeFormatter$HourCycle;
    ...
    invoke-static {p1, p0}, Ljava/text/DateFormat;->getTimeInstance(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 129
    invoke-static {p0}, Lcom/facebook/hermes/intl/PlatformDateTimeFormatterAndroid$PatternUtils;->getPatternWithoutLiterals(Ljava/lang/String;)Ljava/lang/String;
