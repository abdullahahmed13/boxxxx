...
.method private initialize(Landroid/icu/text/NumberFormat;Lcom/facebook/hermes/intl/ILocaleObject;Lcom/facebook/hermes/intl/IPlatformNumberFormatter$Style;)V
    ...
    .line 58
    invoke-virtual {p1, p0}, Landroid/icu/text/NumberFormat;->setRoundingMode(I)V
...
.method public fieldToString(Ljava/text/AttributedCharacterIterator$Attribute;D)Ljava/lang/String;
    ...
    .line 252
    const-string/jumbo p0, "plusSign"

    return-object p0

    .line 254
    :cond_0
    const-string p0, "minusSign"
    ...
    .line 269
    const-string p0, "exponentInteger"
    ...
    .line 272
    const-string p0, "exponentMinusSign"
    ...
    .line 275
    const-string p0, "exponentSeparator"
    ...
    .line 284
    const-string/jumbo p0, "percentSign"
    ...
    .line 287
    const-string/jumbo p0, "permilleSign"
    ...
    const-string p1, "android.icu.text.NumberFormat$Field(compact)"
...
.method public format(D)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/facebook/hermes/intl/PlatformNumberFormatterICU;->mMeasureUnit:Landroid/icu/util/MeasureUnit;

    invoke-direct {v1, v2, p0}, Landroid/icu/util/Measure;-><init>(Ljava/lang/Number;Landroid/icu/util/MeasureUnit;)V
...
.method public formatToParts(D)Ljava/text/AttributedCharacterIterator;
    ...
    invoke-direct {v2, v3, p0}, Landroid/icu/util/Measure;-><init>(Ljava/lang/Number;Landroid/icu/util/MeasureUnit;)V
    ...
    invoke-virtual {v1, p0}, Ljava/text/Format;->formatToCharacterIterator(Ljava/lang/Object;)Ljava/text/AttributedCharacterIterator;
    ...
    invoke-virtual {p0, v1}, Landroid/icu/text/NumberFormat;->formatToCharacterIterator(Ljava/lang/Object;)Ljava/text/AttributedCharacterIterator;
...
.method public setSignificantDigits(Lcom/facebook/hermes/intl/IPlatformNumberFormatter$RoundingType;II)Lcom/facebook/hermes/intl/PlatformNumberFormatterICU;
    ...
    const-string p1, "maximumSignificantDigits should be at least equal to minimumSignificantDigits"
