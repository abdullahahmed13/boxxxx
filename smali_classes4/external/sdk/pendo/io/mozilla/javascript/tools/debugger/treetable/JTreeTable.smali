.class public Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$ListToTreeSelectionModelWrapper;,
        Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellEditor;,
        Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellRenderer;
    }
.end annotation
...
# instance fields
.field protected tree:Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellRenderer;


# direct methods
.method public constructor <init>(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/TreeTableModel;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setSelectionModel(Ljavax/swing/ListSelectionModel;)V
    ...
    const-class v0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/TreeTableModel;

    invoke-virtual {p0, v0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setDefaultRenderer(Ljava/lang/Class;Ljavax/swing/table/TableCellRenderer;)V
    ...
    invoke-virtual {p0, v0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setDefaultEditor(Ljava/lang/Class;Ljavax/swing/table/TableCellEditor;)V

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setShowGrid(Z)V

    new-instance v0, Ljava/awt/Dimension;

    invoke-direct {v0, p1, p1}, Ljava/awt/Dimension;-><init>(II)V

    invoke-virtual {p0, v0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setIntercellSpacing(Ljava/awt/Dimension;)V
...
.method public getEditingRow()I
    ...
    iget v0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->editingColumn:I

    invoke-virtual {p0, v0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->getColumnClass(I)Ljava/lang/Class;
    ...
    :cond_0
    iget p0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->editingRow:I
...
.method public setRowHeight(I)V
    ...
    invoke-virtual {v0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellRenderer;->getRowHeight()I
    ...
    invoke-virtual {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable;->getRowHeight()I

    move-result p0

    invoke-virtual {p1, p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellRenderer;->setRowHeight(I)V
...
.method public updateUI()V
    ...
    invoke-virtual {v0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/treetable/JTreeTable$TreeTableCellRenderer;->updateUI()V
