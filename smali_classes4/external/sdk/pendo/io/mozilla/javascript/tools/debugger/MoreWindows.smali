.class Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$MouseHandler;
    }
.end annotation
...
.field private swingGui:Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;

.field private value:Ljava/lang/String;


# direct methods
.method constructor <init>(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;",
            "Ljava/util/Map<",
            "Ljava/lang/String;",
    ...
    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->swingGui:Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;
    ...
    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->cancelButton:Ljavax/swing/JButton;
    ...
    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setButton:Ljavax/swing/JButton;

    iget-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->cancelButton:Ljavax/swing/JButton;

    invoke-virtual {p1, p0}, Ljavax/swing/JButton;->addActionListener(Ljava/awt/event/ActionListener;)V

    iget-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setButton:Ljavax/swing/JButton;

    invoke-virtual {p1, p0}, Ljavax/swing/JButton;->addActionListener(Ljava/awt/event/ActionListener;)V

    invoke-virtual {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->getRootPane()Ljavax/swing/JRootPane;

    move-result-object p1

    iget-object p3, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setButton:Ljavax/swing/JButton;
    ...
    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->list:Ljavax/swing/JList;
    ...
    :cond_0
    iget-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->list:Ljavax/swing/JList;
    ...
    new-instance p3, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$MouseHandler;

    const/4 v1, 0x0

    invoke-direct {p3, p0, v1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$MouseHandler;-><init>(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$1;)V
    ...
    iget-object p3, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->list:Ljavax/swing/JList;
    ...
    iget-object p4, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->list:Ljavax/swing/JList;
    ...
    iget-object v0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->cancelButton:Ljavax/swing/JButton;
    ...
    invoke-virtual {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->getContentPane()Ljava/awt/Container;
    ...
    invoke-virtual {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->pack()V

    new-instance p1, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$1;

    invoke-direct {p1, p0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows$1;-><init>(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;)V

    invoke-virtual {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->addKeyListener(Ljava/awt/event/KeyListener;)V

    return-void
.end method

.method static synthetic access$102(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->value:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic access$200(Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;)Ljavax/swing/JButton;
    .locals 0

    iget-object p0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setButton:Ljavax/swing/JButton;
...
.method public actionPerformed(Ljava/awt/event/ActionEvent;)V
    ...
    invoke-virtual {p0, v1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setVisible(Z)V
    ...
    iget-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->swingGui:Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;

    iget-object p0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->value:Ljava/lang/String;

    const/4 v0, -0x1

    invoke-virtual {p1, p0, v0}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/SwingGui;->showFileWindow(Ljava/lang/String;I)V
...
.method public showDialog(Ljava/awt/Component;)Ljava/lang/String;
    ...
    iput-object v0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->value:Ljava/lang/String;

    invoke-virtual {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/tools/debugger/MoreWindows;->setLocationRelativeTo(Ljava/awt/Component;)V
