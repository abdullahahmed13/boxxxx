.class final Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->primitives:[Ljava/lang/Class;
...
.method constructor <init>(Ljava/lang/reflect/Constructor;)V
    ...
    invoke-direct {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->init(Ljava/lang/reflect/Constructor;)V
...
.method constructor <init>(Ljava/lang/reflect/Method;)V
    ...
    invoke-direct {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->init(Ljava/lang/reflect/Method;)V
...
.method private init(Ljava/lang/reflect/Constructor;)V
    ...
    .line 1
    iput-object p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->memberObject:Ljava/lang/reflect/Member;

    invoke-virtual {p1}, Ljava/lang/reflect/Constructor;->getParameterTypes()[Ljava/lang/Class;

    move-result-object v0

    iput-object v0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->argTypes:[Ljava/lang/Class;

    invoke-virtual {p1}, Ljava/lang/reflect/Constructor;->isVarArgs()Z

    move-result p1

    iput-boolean p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->vararg:Z
...
.method private static readMember(Ljava/io/ObjectInputStream;)Ljava/lang/reflect/Member;
    ...
    invoke-static {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->readParameters(Ljava/io/ObjectInputStream;)[Ljava/lang/Class;
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-static {p1}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->readMember(Ljava/io/ObjectInputStream;)Ljava/lang/reflect/Member;
...
.method private static readParameters(Ljava/io/ObjectInputStream;)[Ljava/lang/Class;
    ...
    :cond_0
    sget-object v3, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->primitives:[Ljava/lang/Class;
...
.method private static writeMember(Ljava/io/ObjectOutputStream;Ljava/lang/reflect/Member;)V
    ...
    const-string/jumbo p1, "not Method or Constructor"
    ...
    invoke-static {p0, p1}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->writeParameters(Ljava/io/ObjectOutputStream;[Ljava/lang/Class;)V
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    iget-object p0, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->memberObject:Ljava/lang/reflect/Member;

    invoke-static {p1, p0}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->writeMember(Ljava/io/ObjectOutputStream;Ljava/lang/reflect/Member;)V
...
.method private static writeParameters(Ljava/io/ObjectOutputStream;[Ljava/lang/Class;)V
    ...
    :goto_1
    sget-object v4, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->primitives:[Ljava/lang/Class;
...
.method invoke(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v2, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->argTypes:[Ljava/lang/Class;

    invoke-static {v0, v2}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->searchAccessibleMethod(Ljava/lang/reflect/Method;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v2

    if-eqz v2, :cond_0

    iput-object v2, p0, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->memberObject:Ljava/lang/reflect/Member;
    ...
    :cond_0
    sget-object p0, Lexternal/sdk/pendo/io/mozilla/javascript/VMBridge;->instance:Lexternal/sdk/pendo/io/mozilla/javascript/VMBridge;

    invoke-virtual {p0, v0}, Lexternal/sdk/pendo/io/mozilla/javascript/VMBridge;->tryToMakeAccessible(Ljava/lang/reflect/AccessibleObject;)Z
    ...
    :cond_1
    invoke-static {v1}, Lexternal/sdk/pendo/io/mozilla/javascript/Context;->throwAsScriptRuntimeEx(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    ...
    instance-of p1, p0, Lexternal/sdk/pendo/io/mozilla/javascript/ContinuationPending;

    if-eqz p1, :cond_3

    check-cast p0, Lexternal/sdk/pendo/io/mozilla/javascript/ContinuationPending;
...
.method newInstance([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p0}, Lexternal/sdk/pendo/io/mozilla/javascript/VMBridge;->tryToMakeAccessible(Ljava/lang/reflect/AccessibleObject;)Z
    ...
    :cond_0
    invoke-static {v0}, Lexternal/sdk/pendo/io/mozilla/javascript/Context;->throwAsScriptRuntimeEx(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method toJavaDeclaration()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lexternal/sdk/pendo/io/mozilla/javascript/MemberBox;->isMethod()Z
