...
.method public isDisposed()Z
    ...
    .line 197
    iget-boolean p0, p0, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker;->disposed:Z
...
.method public now(Ljava/util/concurrent/TimeUnit;)J
    ...
    .line 231
    iget-object p0, p0, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker;->this$0:Lio/reactivex/rxjava3/schedulers/TestScheduler;
...
.method public schedule(Ljava/lang/Runnable;)Lio/reactivex/rxjava3/disposables/Disposable;
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker;->this$0:Lio/reactivex/rxjava3/schedulers/TestScheduler;

    iget-wide v5, p1, Lio/reactivex/rxjava3/schedulers/TestScheduler;->counter:J

    const-wide/16 v1, 0x1

    add-long/2addr v1, v5

    iput-wide v1, p1, Lio/reactivex/rxjava3/schedulers/TestScheduler;->counter:J
    ...
    .line 225
    iget-object p0, v1, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker;->this$0:Lio/reactivex/rxjava3/schedulers/TestScheduler;

    iget-object p0, p0, Lio/reactivex/rxjava3/schedulers/TestScheduler;->queue:Ljava/util/Queue;

    invoke-interface {p0, v0}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    .line 226
    new-instance p0, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker$QueueRemove;

    invoke-direct {p0, v1, v0}, Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker$QueueRemove;-><init>(Lio/reactivex/rxjava3/schedulers/TestScheduler$TestWorker;Lio/reactivex/rxjava3/schedulers/TestScheduler$TimedRunnable;)V
...
.method public schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/Disposable;
    ...
    iget-wide v1, p1, Lio/reactivex/rxjava3/schedulers/TestScheduler;->time:J
    ...
    iput-wide p2, p1, Lio/reactivex/rxjava3/schedulers/TestScheduler;->counter:J
