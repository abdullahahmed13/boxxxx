...
.method public final compose(Lio/reactivex/rxjava3/parallel/ParallelTransformer;)Lio/reactivex/rxjava3/parallel/ParallelFlowable;
    ...
    invoke-static {p0}, Lio/reactivex/rxjava3/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/rxjava3/parallel/ParallelFlowable;)Lio/reactivex/rxjava3/parallel/ParallelFlowable;
...
.method public final sorted(Ljava/util/Comparator;I)Lio/reactivex/rxjava3/core/Flowable;
    ...
    .line 649
    new-instance p2, Lio/reactivex/rxjava3/internal/util/SorterFunction;

    invoke-direct {p2, p1}, Lio/reactivex/rxjava3/internal/util/SorterFunction;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {p0, p2}, Lio/reactivex/rxjava3/parallel/ParallelFlowable;->map(Lio/reactivex/rxjava3/functions/Function;)Lio/reactivex/rxjava3/parallel/ParallelFlowable;

    move-result-object p0

    .line 651
    new-instance p2, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelSortedJoin;

    invoke-direct {p2, p0, p1}, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelSortedJoin;-><init>(Lio/reactivex/rxjava3/parallel/ParallelFlowable;Ljava/util/Comparator;)V

    invoke-static {p2}, Lio/reactivex/rxjava3/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/rxjava3/core/Flowable;)Lio/reactivex/rxjava3/core/Flowable;
...
.method public final toSortedList(Ljava/util/Comparator;I)Lio/reactivex/rxjava3/core/Flowable;
    ...
    .line 707
    new-instance p2, Lio/reactivex/rxjava3/internal/util/MergerBiFunction;

    invoke-direct {p2, p1}, Lio/reactivex/rxjava3/internal/util/MergerBiFunction;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {p0, p2}, Lio/reactivex/rxjava3/parallel/ParallelFlowable;->reduce(Lio/reactivex/rxjava3/functions/BiFunction;)Lio/reactivex/rxjava3/core/Flowable;
...
.method protected final validate([Lorg/reactivestreams/Subscriber;)Z
    ...
    .line 86
    invoke-static {v0, v3}, Lio/reactivex/rxjava3/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lorg/reactivestreams/Subscriber;)V
