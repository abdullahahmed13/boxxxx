.class public Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;
...
.method public constructor <init>(Lio/split/android/client/storage/rbs/RuleBasedSegmentStorage;Lio/split/android/client/service/rules/RuleBasedSegmentChangeProcessor;Lio/split/android/client/events/ISplitEventsManager;Lio/split/android/client/dtos/RuleBasedSegment;J)V
    ...
    iput-object p1, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mRuleBasedSegmentStorage:Lio/split/android/client/storage/rbs/RuleBasedSegmentStorage;
    ...
    iput-object p1, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mRuleBasedSegment:Lio/split/android/client/dtos/RuleBasedSegment;
    ...
    iput-object p1, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mChangeProcessor:Lio/split/android/client/service/rules/RuleBasedSegmentChangeProcessor;

    .line 34
    iput-object p3, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mEventsManager:Lio/split/android/client/events/ISplitEventsManager;

    .line 35
    iput-wide p5, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mChangeNumber:J
...
.method public execute()Lio/split/android/client/service/executor/SplitTaskExecutionInfo;
    ...
    .line 42
    :try_start_0
    iget-object v0, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mChangeProcessor:Lio/split/android/client/service/rules/RuleBasedSegmentChangeProcessor;

    iget-object v1, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mRuleBasedSegment:Lio/split/android/client/dtos/RuleBasedSegment;

    iget-wide v2, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mChangeNumber:J
    ...
    .line 43
    iget-object v1, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mRuleBasedSegmentStorage:Lio/split/android/client/storage/rbs/RuleBasedSegmentStorage;
    ...
    iget-wide v3, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mChangeNumber:J
    ...
    .line 46
    iget-object p0, p0, Lio/split/android/client/service/splits/RuleBasedSegmentInPlaceUpdateTask;->mEventsManager:Lio/split/android/client/events/ISplitEventsManager;
