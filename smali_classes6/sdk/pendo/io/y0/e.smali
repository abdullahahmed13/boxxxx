.class public Lsdk/pendo/io/y0/e;
...
.field public static final e:Ljava/security/spec/ECParameterSpec;

.field public static final f:Ljava/security/spec/ECParameterSpec;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lsdk/pendo/io/y0/e;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lsdk/pendo/io/y0/e;->b:Ljava/util/Map;
    ...
    sput-object v0, Lsdk/pendo/io/y0/e;->c:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v1, Lsdk/pendo/io/y0/e;->d:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v2, Lsdk/pendo/io/y0/e;->e:Ljava/security/spec/ECParameterSpec;
    ...
    const-string v8, "115792089237316195423570985008687907853269984665640564039457584007908834671663"
    ...
    const-string v8, "55066263022277343669578718895168534326250603453777594175500187360389116729240"

    invoke-direct {v7, v8}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;)V

    new-instance v8, Ljava/math/BigInteger;

    const-string v9, "32670510020758816978083085130507043184471273380659243275938904335757337482424"
    ...
    const-string v8, "115792089237316195423570985008687907852837564279074904382605163141518161494337"

    invoke-direct {v7, v8}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;)V

    invoke-direct {v3, v5, v6, v7, v4}, Ljava/security/spec/ECParameterSpec;-><init>(Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V

    sput-object v3, Lsdk/pendo/io/y0/e;->f:Ljava/security/spec/ECParameterSpec;

    const-string v4, "P-256"

    invoke-static {v4, v0}, Lsdk/pendo/io/y0/e;->a(Ljava/lang/String;Ljava/security/spec/ECParameterSpec;)V

    const-string v0, "P-384"

    invoke-static {v0, v1}, Lsdk/pendo/io/y0/e;->a(Ljava/lang/String;Ljava/security/spec/ECParameterSpec;)V

    const-string v0, "P-521"

    invoke-static {v0, v2}, Lsdk/pendo/io/y0/e;->a(Ljava/lang/String;Ljava/security/spec/ECParameterSpec;)V

    const-string/jumbo v0, "secp256k1"

    invoke-static {v0, v3}, Lsdk/pendo/io/y0/e;->a(Ljava/lang/String;Ljava/security/spec/ECParameterSpec;)V

    return-void
.end method

.method public static a(Ljava/security/spec/EllipticCurve;)Ljava/lang/String;
    .locals 1

    .line 2
    sget-object v0, Lsdk/pendo/io/y0/e;->b:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    .locals 1

    .line 3
    sget-object v0, Lsdk/pendo/io/y0/e;->a:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;Ljava/security/spec/ECParameterSpec;)V
    .locals 1
