...
.method public assertIsOnThread()V
    ...
    .line 41
    iget-object p0, p0, Lcom/swmansion/worklets/WorkletsMessageQueueThreadBase;->messageQueueThread:Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;

    invoke-virtual {p0}, Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;->assertIsOnThread()V
...
.method public assertIsOnThread(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;->assertIsOnThread(Ljava/lang/String;)V
...
.method public callOnQueue(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;->callOnQueue(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
...
.method public getPerfStats()Lcom/facebook/react/bridge/queue/MessageQueueThreadPerfStats;
    ...
    invoke-virtual {p0}, Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;->getPerfStats()Lcom/facebook/react/bridge/queue/MessageQueueThreadPerfStats;
...
.method public resetPerfStats()V
    ...
    invoke-virtual {p0}, Lcom/facebook/react/bridge/queue/MessageQueueThreadImpl;->resetPerfStats()V
