...
.method public constructor <init>(Lcom/nimbusds/jose/jwk/JWK;Ljava/util/Set;)V
    ...
    const-string p1, "The private key (JWK) must not be null"
...
.method public decrypt(Lcom/nimbusds/jose/JWEHeader;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;[B)[B
    ...
    invoke-direct {p2, p0, v2}, Lcom/nimbusds/jose/crypto/RSADecrypter;-><init>(Ljava/security/PrivateKey;Ljava/util/Set;)V
    ...
    invoke-direct {p2, p0, v2}, Lcom/nimbusds/jose/crypto/ECDHDecrypter;-><init>(Ljava/security/interfaces/ECPrivateKey;Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v3}, Lcom/nimbusds/jose/jwk/OctetSequenceKey;->toSecretKey(Ljava/lang/String;)Ljavax/crypto/SecretKey;

    move-result-object p0

    invoke-direct {p2, p0, v2}, Lcom/nimbusds/jose/crypto/AESDecrypter;-><init>(Ljavax/crypto/SecretKey;Ljava/util/Set;)V
    ...
    invoke-direct {p2, p0, v2}, Lcom/nimbusds/jose/crypto/DirectDecrypter;-><init>(Ljavax/crypto/SecretKey;Ljava/util/Set;)V
    ...
    sget-object v0, Lcom/nimbusds/jose/crypto/X25519Decrypter;->SUPPORTED_ALGORITHMS:Ljava/util/Set;
    ...
    invoke-direct {p2, p0, v2}, Lcom/nimbusds/jose/crypto/X25519Decrypter;-><init>(Lcom/nimbusds/jose/jwk/OctetKeyPair;Ljava/util/Set;)V
    ...
    const-string p1, "No recipient found"
    ...
    const-string p1, "Missing JWE additional authenticated data (AAD)"
