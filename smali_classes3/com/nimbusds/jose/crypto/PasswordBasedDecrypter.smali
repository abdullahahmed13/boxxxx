...
.method public decrypt(Lcom/nimbusds/jose/JWEHeader;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;Lcom/nimbusds/jose/util/Base64URL;[B)[B
    ...
    invoke-virtual {v4}, Lcom/nimbusds/jose/jca/JWEJCAContext;->getProvider()Ljava/security/Provider;

    move-result-object v4

    invoke-static {v3, v0, v1, v2, v4}, Lcom/nimbusds/jose/crypto/impl/PBKDF2;->deriveKey([B[BILcom/nimbusds/jose/crypto/impl/PRFParams;Ljava/security/Provider;)Ljavax/crypto/SecretKey;
    ...
    const-string p1, "The JWE p2c header exceeds the maximum allowed 1000000 count"
    ...
    const-string p1, "Missing JWE p2c header parameter"
    ...
    const-string p1, "Missing JWE p2s header parameter"
    ...
    const-string p1, "Missing JWE initialization vector (IV)"
    ...
    const-string p1, "Missing JWE encrypted key"
