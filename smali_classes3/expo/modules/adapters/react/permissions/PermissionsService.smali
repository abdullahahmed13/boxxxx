...
.method private final addToAskedPermissionsCache([Ljava/lang/String;)V
    ...
    .line 47
    iget-object p0, p0, Lexpo/modules/adapters/react/permissions/PermissionsService;->mAskedPermissionsCache:Landroid/content/SharedPreferences;

    if-nez p0, :cond_0

    const-string p0, "mAskedPermissionsCache"
...
.method private final askForWriteSettingsPermissionFirst()V
    ...
    .line 323
    iget-object p0, p0, Lexpo/modules/adapters/react/permissions/PermissionsService;->context:Landroid/content/Context;
...
.method private final canAskAgain(Ljava/lang/String;)Z
    ...
    .line 217
    iget-object p0, p0, Lexpo/modules/adapters/react/permissions/PermissionsService;->mActivityProvider:Lexpo/modules/core/interfaces/ActivityProvider;

    const/4 v0, 0x0

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lexpo/modules/core/interfaces/ActivityProvider;->getCurrentActivity()Landroid/app/Activity;
...
.method private final getPermissionResponseFromNativeResponse(Ljava/lang/String;I)Lexpo/modules/interfaces/permissions/PermissionsResponse;
    ...
    .line 236
    :goto_1
    invoke-direct {v0, p2, p0}, Lexpo/modules/interfaces/permissions/PermissionsResponse;-><init>(Lexpo/modules/interfaces/permissions/PermissionsStatus;Z)V
...
.method public varargs askForPermissions(Lexpo/modules/interfaces/permissions/PermissionsResponseListener;[Ljava/lang/String;)V
    ...
    invoke-interface {p1, p0}, Lexpo/modules/interfaces/permissions/PermissionsResponseListener;->onResult(Ljava/util/Map;)V
    ...
    const-string p1, "Another permissions request is in progress. Await the old request and then try again."
    ...
    invoke-interface {v2, p0}, Lexpo/modules/interfaces/permissions/PermissionsResponseListener;->onResult(Ljava/util/Map;)V
...
.method protected final delegateRequestToActivity([Ljava/lang/String;Lexpo/modules/interfaces/permissions/PermissionsResponseListener;)V
    ...
    invoke-interface {p2, p0}, Lexpo/modules/interfaces/permissions/PermissionsResponseListener;->onResult(Ljava/util/Map;)V
...
.method public getExportedInterfaces()Ljava/util/List;
    ...
    .line 52
    const-class p0, Lexpo/modules/interfaces/permissions/Permissions;
...
.method public onCreate(Lexpo/modules/core/ModuleRegistry;)V
    ...
    const-string p1, "Couldn\'t find implementation for ActivityProvider."
...
.method public onHostResume()V
    ...
    invoke-interface {v1, p0}, Lexpo/modules/interfaces/permissions/PermissionsResponseListener;->onResult(Ljava/util/Map;)V
