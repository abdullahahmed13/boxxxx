...
.method private final getCachedListeners(Landroid/app/Application;)Ljava/util/List;
    ...
    .line 13
    sget-object p0, Lexpo/modules/ApplicationLifecycleDispatcher;->listeners:Ljava/util/List;

    if-nez p0, :cond_1

    sget-object p0, Lexpo/modules/ExpoModulesPackage;->Companion:Lexpo/modules/ExpoModulesPackage$Companion;

    invoke-virtual {p0}, Lexpo/modules/ExpoModulesPackage$Companion;->getPackageList()Ljava/util/List;
    ...
    invoke-interface {v1, v2}, Lexpo/modules/core/interfaces/Package;->createApplicationLifecycleListeners(Landroid/content/Context;)Ljava/util/List;

    move-result-object v1

    const-string v2, "createApplicationLifecycleListeners(...)"
