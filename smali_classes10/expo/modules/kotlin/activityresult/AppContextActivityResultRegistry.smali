...
.method private final doDispatch(Ljava/lang/String;ILandroid/content/Intent;Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry$CallbacksAndContract;)V
    ...
    .line 335
    :cond_3
    iget-object p0, p0, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry;->pendingResults:Landroid/os/Bundle;
...
.method private final getActivity()Landroidx/appcompat/app/AppCompatActivity;
    ...
    .line 90
    iget-object p0, p0, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry;->currentActivityProvider:Lexpo/modules/kotlin/providers/CurrentActivityProvider;

    invoke-interface {p0}, Lexpo/modules/kotlin/providers/CurrentActivityProvider;->getCurrentActivity()Landroid/app/Activity;
    ...
    const-string v0, "Current Activity is not available at the moment"
...
.method public final onLaunch(ILexpo/modules/kotlin/activityresult/AppContextActivityResultContract;Ljava/io/Serializable;)V
    ...
    new-instance p3, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry$$ExternalSyntheticLambda0;

    invoke-direct {p3, p0, v3, p1}, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry$$ExternalSyntheticLambda0;-><init>(Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry;ILandroid/content/IntentSender$SendIntentException;)V
    ...
    invoke-static {p0, p2, v3, v8}, Landroidx/core/app/ActivityCompat;->startActivityForResult(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
...
.method public final persistInstanceState(Landroid/content/Context;)V
    ...
    .line 252
    iget-object p0, p0, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry;->random:Ljava/util/Random;

    check-cast p0, Ljava/io/Serializable;

    const-string v0, "random"

    invoke-virtual {p1, v0, p0}, Lexpo/modules/kotlin/activityresult/DataPersistor;->addSerializable(Ljava/lang/String;Ljava/io/Serializable;)Lexpo/modules/kotlin/activityresult/DataPersistor;

    move-result-object p0

    .line 253
    invoke-virtual {p0}, Lexpo/modules/kotlin/activityresult/DataPersistor;->persist()V
...
.method public final unregister(Ljava/lang/String;)V
    ...
    .line 290
    iget-object p0, p0, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry;->keyToLifecycleContainers:Ljava/util/Map;

    invoke-interface {p0, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lexpo/modules/kotlin/activityresult/AppContextActivityResultRegistry$LifecycleContainer;
