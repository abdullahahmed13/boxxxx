...
.method private final bisectToSegment(DD)[[D
    ...
    .line 509
    invoke-direct {v0, v3, v4, v13}, Landroidx/compose/material3/internal/colorUtil/HctSolver;->nthVertex(DI)[D
...
.method private final chromaticAdaptation(D)D
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/material3/internal/colorUtil/CamUtils;->signum(D)I
...
.method private final findResultByJ(DDD)I
    ...
    aget-wide v15, v15, v0

    mul-double/2addr v15, v13

    add-double v30, v24, v15
...
.method private final setCoordinate([DD[DI)[D
    ...
    .line 446
    invoke-direct {v0, p1, p2, p3, p4}, Landroidx/compose/material3/internal/colorUtil/HctSolver;->lerpPoint([DD[D)[D
...
.method public final solveToInt(DDD)I
    ...
    .line 695
    :cond_1
    invoke-direct {v0, v5, v6, v1, v2}, Landroidx/compose/material3/internal/colorUtil/HctSolver;->bisectToLimit(DD)I
    ...
    invoke-virtual {p0, p5, p6}, Landroidx/compose/material3/internal/colorUtil/CamUtils;->argbFromLstar(D)I
