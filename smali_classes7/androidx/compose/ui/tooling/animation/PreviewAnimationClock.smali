...
# direct methods
.method public static synthetic $r8$lambda$0Z-hysRzfboihZLlH7oJFpdu0EE(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackAnimatedContent$lambda$0(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$8Jl1L65iUDF70sCBHifmabfXdeU(Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/String;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackUnsupported$lambda$0(Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/String;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$9sry9sWVyFIPWCeiQGt3DM0YoJc(Landroidx/compose/animation/core/Transition;Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackAnimatedVisibility$lambda$1(Landroidx/compose/animation/core/Transition;Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$PVDyrILnM5RVzpk6XwAEg1zW6vM()Lkotlin/Unit;
    .locals 1
...
.method public static synthetic $r8$lambda$QeldIqLsIdszFhSHUk36inqYwUs(Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackAnimateXAsState$lambda$0(Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$X8rL7ukz0MqmKOu2gI84O-qKmgU(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackTransition$lambda$0(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$ceOPYUb1OuyW788YApVUpu0ApUM(Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->trackInfiniteTransition$lambda$0(Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$rWFEAdKOwo8Y0timXnXnpZJ6lvc()Lkotlin/Unit;
    .locals 1
...
.method private final findClock(Landroidx/compose/animation/tooling/ComposeAnimation;)Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;
    ...
    .line 118
    :cond_3
    iget-object p0, p0, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->animatedContentClocks:Ljava/util/Map;

    invoke-interface {p0, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;
...
.method private final getAllClocks()Ljava/util/List;
    ...
    iget-object p0, p0, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->infiniteTransitionClocks:Ljava/util/Map;
...
.method private static final trackAnimateXAsState$lambda$0(Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 1

    .line 151
    sget-object p2, Landroidx/compose/ui/tooling/animation/AnimateXAsStateComposeAnimation;->Companion:Landroidx/compose/ui/tooling/animation/AnimateXAsStateComposeAnimation$Companion;

    invoke-virtual {p2, p0}, Landroidx/compose/ui/tooling/animation/AnimateXAsStateComposeAnimation$Companion;->parse$ui_tooling(Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearchInfo;)Landroidx/compose/ui/tooling/animation/AnimateXAsStateComposeAnimation;
    ...
    .line 152
    iget-object p0, p1, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->animateXAsStateClocks:Ljava/util/Map;

    new-instance v0, Landroidx/compose/ui/tooling/animation/clock/AnimateXAsStateClock;

    invoke-direct {v0, p2}, Landroidx/compose/ui/tooling/animation/clock/AnimateXAsStateClock;-><init>(Landroidx/compose/ui/tooling/animation/AnimateXAsStateComposeAnimation;)V
    ...
    invoke-direct {p1, p0}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->createUnsupported(Ljava/lang/String;)V
...
.method private static final trackAnimatedContent$lambda$0(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 2

    .line 176
    sget-object p2, Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation;->Companion:Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation$Companion;

    invoke-virtual {p2, p0}, Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation$Companion;->parseAnimatedContent(Landroidx/compose/animation/core/Transition;)Landroidx/compose/ui/tooling/animation/AnimatedContentComposeAnimation;
    ...
    .line 177
    iget-object p0, p1, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->animatedContentClocks:Ljava/util/Map;

    new-instance v0, Landroidx/compose/ui/tooling/animation/clock/TransitionClock;

    move-object v1, p2

    check-cast v1, Landroidx/compose/ui/tooling/animation/TransitionBasedAnimation;

    invoke-direct {v0, v1}, Landroidx/compose/ui/tooling/animation/clock/TransitionClock;-><init>(Landroidx/compose/ui/tooling/animation/TransitionBasedAnimation;)V
...
.method private static final trackAnimatedVisibility$lambda$0()Lkotlin/Unit;
    .locals 1
...
.method private static final trackAnimatedVisibility$lambda$1(Landroidx/compose/animation/core/Transition;Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 2

    .line 140
    const-string/jumbo p3, "null cannot be cast to non-null type androidx.compose.animation.core.Transition<kotlin.Boolean>"
    ...
    .line 143
    iget-object p1, p2, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->animatedVisibilityClocks:Ljava/util/Map;

    .line 144
    new-instance p3, Landroidx/compose/ui/tooling/animation/clock/AnimatedVisibilityClock;

    invoke-direct {p3, p0}, Landroidx/compose/ui/tooling/animation/clock/AnimatedVisibilityClock;-><init>(Landroidx/compose/ui/tooling/animation/AnimatedVisibilityComposeAnimation;)V

    const-wide/16 v0, 0x0

    invoke-virtual {p3, v0, v1}, Landroidx/compose/ui/tooling/animation/clock/AnimatedVisibilityClock;->setClockTime(J)V
    ...
    invoke-virtual {p2, p0}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->notifySubscribe(Landroidx/compose/animation/tooling/ComposeAnimation;)V
...
.method private final trackAnimation(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)Z
    ...
    const-string p2, " is already being tracked"
    ...
    const-string p2, " is now tracked"
...
.method private static final trackInfiniteTransition$lambda$0(Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 2

    .line 188
    sget-object p2, Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation;->Companion:Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation$Companion;

    invoke-virtual {p2, p0}, Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation$Companion;->parse$ui_tooling(Landroidx/compose/ui/tooling/animation/AnimationSearch$InfiniteTransitionSearchInfo;)Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation;
    ...
    .line 189
    iget-object p2, p1, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->infiniteTransitionClocks:Ljava/util/Map;

    .line 190
    new-instance v0, Landroidx/compose/ui/tooling/animation/clock/InfiniteTransitionClock;

    .line 189
    new-instance v1, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock$$ExternalSyntheticLambda4;

    invoke-direct {v1, p1}, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock$$ExternalSyntheticLambda4;-><init>(Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;)V

    .line 190
    invoke-direct {v0, p0, v1}, Landroidx/compose/ui/tooling/animation/clock/InfiniteTransitionClock;-><init>(Landroidx/compose/ui/tooling/animation/InfiniteTransitionComposeAnimation;Lkotlin/jvm/functions/Function0;)V
...
.method private static final trackTransition$lambda$0(Landroidx/compose/animation/core/Transition;Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 2
    ...
    .line 124
    iget-object p0, p1, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->transitionClocks:Ljava/util/Map;
...
.method private static final trackUnsupported$lambda$0(Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;Ljava/lang/String;Ljava/lang/Object;)Lkotlin/Unit;
    .locals 0
...
.method public final getAnimateXAsStateClocks$ui_tooling()Ljava/util/Map;
    ...
    .line 84
    iget-object p0, p0, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->animateXAsStateClocks:Ljava/util/Map;
...
.method public final getAnimatedProperties(Landroidx/compose/animation/tooling/ComposeAnimation;)Ljava/util/List;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;->getAnimatedProperties()Ljava/util/List;
...
.method public final getAnimatedVisibilityState-cc2g1to(Landroidx/compose/animation/tooling/ComposeAnimation;)Ljava/lang/String;
    ...
    check-cast p0, Landroidx/compose/ui/tooling/animation/clock/AnimatedVisibilityClock;
...
.method public final getMaxDuration()J
    ...
    invoke-interface {v0}, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;->getMaxDuration()J
...
.method public final getTransitionClocks$ui_tooling()Ljava/util/Map;
    ...
    .line 68
    iget-object p0, p0, Landroidx/compose/ui/tooling/animation/PreviewAnimationClock;->transitionClocks:Ljava/util/Map;
...
.method public final getTransitions(Landroidx/compose/animation/tooling/ComposeAnimation;J)Ljava/util/List;
    ...
    invoke-interface {p0, p2, p3}, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;->getTransitions(J)Ljava/util/List;
...
.method public final updateAnimatedVisibilityState(Landroidx/compose/animation/tooling/ComposeAnimation;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p2, v0, p1, v0}, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;->setStateParameters$default(Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;Ljava/lang/Object;Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final updateFromAndToStates(Landroidx/compose/animation/tooling/ComposeAnimation;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-interface {p0, p2, p3}, Landroidx/compose/ui/tooling/animation/clock/ComposeAnimationClock;->setStateParameters(Ljava/lang/Object;Ljava/lang/Object;)V
