...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/j256/ormlite/logger/Log$Level;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/j256/ormlite/logger/Log$Level;->DEBUG:Lcom/j256/ormlite/logger/Log$Level;

    .line 34
    new-instance v2, Lcom/j256/ormlite/logger/Log$Level;

    const-string v3, "INFO"

    const/4 v5, 0x3

    invoke-direct {v2, v3, v4, v5}, Lcom/j256/ormlite/logger/Log$Level;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/j256/ormlite/logger/Log$Level;->INFO:Lcom/j256/ormlite/logger/Log$Level;

    .line 36
    new-instance v3, Lcom/j256/ormlite/logger/Log$Level;

    const-string v4, "WARNING"

    const/4 v6, 0x4

    invoke-direct {v3, v4, v5, v6}, Lcom/j256/ormlite/logger/Log$Level;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/j256/ormlite/logger/Log$Level;->WARNING:Lcom/j256/ormlite/logger/Log$Level;
    ...
    invoke-direct {v4, v5, v6, v7}, Lcom/j256/ormlite/logger/Log$Level;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/j256/ormlite/logger/Log$Level;->ERROR:Lcom/j256/ormlite/logger/Log$Level;

    .line 40
    new-instance v5, Lcom/j256/ormlite/logger/Log$Level;

    const-string v6, "FATAL"

    const/4 v8, 0x6

    invoke-direct {v5, v6, v7, v8}, Lcom/j256/ormlite/logger/Log$Level;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/j256/ormlite/logger/Log$Level;->FATAL:Lcom/j256/ormlite/logger/Log$Level;

    .line 28
    filled-new-array/range {v0 .. v5}, [Lcom/j256/ormlite/logger/Log$Level;
...
.method public isEnabled(Lcom/j256/ormlite/logger/Log$Level;)Z
    ...
    .line 55
    iget p0, p0, Lcom/j256/ormlite/logger/Log$Level;->level:I
