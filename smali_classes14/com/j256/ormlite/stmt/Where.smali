...
.method private addNeedsFuture(Lcom/j256/ormlite/stmt/query/NeedsFutureClause;)V
    ...
    iget-object p0, p0, Lcom/j256/ormlite/stmt/Where;->needsFuture:Lcom/j256/ormlite/stmt/query/NeedsFutureClause;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object p0

    const-string v1, " is already waiting for a future clause, can\'t add: "
...
.method private checkQueryBuilderMethod(Ljava/lang/String;)Lcom/j256/ormlite/stmt/QueryBuilder;
    ...
    invoke-virtual {p0}, Lcom/j256/ormlite/stmt/StatementBuilder;->getType()Lcom/j256/ormlite/stmt/StatementBuilder$StatementType;
...
.method private findColumnFieldType(Ljava/lang/String;)Lcom/j256/ormlite/field/FieldType;
    ...
    .line 648
    iget-object p0, p0, Lcom/j256/ormlite/stmt/Where;->tableInfo:Lcom/j256/ormlite/table/TableInfo;

    invoke-virtual {p0, p1}, Lcom/j256/ormlite/table/TableInfo;->getFieldTypeByColumnName(Ljava/lang/String;)Lcom/j256/ormlite/field/FieldType;
...
.method private varargs in(ZLjava/lang/String;[Ljava/lang/Object;)Lcom/j256/ormlite/stmt/Where;
    ...
    const-string p2, " seems to be an array within an array"
    ...
    const-string p2, " seems to be a Where object, did you mean the QueryBuilder?"
    ...
    const-string p2, " seems to be a prepared statement, did you mean the QueryBuilder?"
...
.method private peek()Lcom/j256/ormlite/stmt/query/Clause;
    ...
    iget p0, p0, Lcom/j256/ormlite/stmt/Where;->clauseStackLevel:I
...
.method public and(I)Lcom/j256/ormlite/stmt/Where;
    ...
    const-string p1, "Must have at least one clause in and(numClauses)"
...
.method appendSql(Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    iget-object p0, p0, Lcom/j256/ormlite/stmt/Where;->databaseType:Lcom/j256/ormlite/db/DatabaseType;

    invoke-interface {v0, p0, p1, p2, p3}, Lcom/j256/ormlite/stmt/query/Clause;->appendSql(Lcom/j256/ormlite/db/DatabaseType;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    const-string p1, "Both the \"left-hand\" and \"right-hand\" clauses have been defined.  Did you miss an AND or OR?"
    ...
    const-string p1, "No where clauses defined.  Did you miss a where operation?"
...
.method public countOf()J
    ...
    invoke-virtual {p0}, Lcom/j256/ormlite/stmt/QueryBuilder;->countOf()J
...
.method public idEq(Lcom/j256/ormlite/dao/Dao;Ljava/lang/Object;)Lcom/j256/ormlite/stmt/Where;
    ...
    const-string p1, "Object has no id column specified"
...
.method public or(I)Lcom/j256/ormlite/stmt/Where;
    ...
    const-string p1, "Must have at least one clause in or(numClauses)"
...
.method public prepare()Lcom/j256/ormlite/stmt/PreparedQuery;
    ...
    invoke-virtual {p0, v0}, Lcom/j256/ormlite/stmt/StatementBuilder;->prepareStatement(Ljava/lang/Long;)Lcom/j256/ormlite/stmt/mapped/MappedPreparedStmt;
...
.method public queryForFirst()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/j256/ormlite/stmt/QueryBuilder;->queryForFirst()Ljava/lang/Object;
...
.method public queryRaw()Lcom/j256/ormlite/dao/GenericRawResults;
    ...
    invoke-virtual {p0}, Lcom/j256/ormlite/stmt/QueryBuilder;->queryRaw()Lcom/j256/ormlite/dao/GenericRawResults;
...
.method public queryRawFirst()[Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/j256/ormlite/stmt/QueryBuilder;->queryRawFirst()[Ljava/lang/String;
...
.method public varargs raw(Ljava/lang/String;[Lcom/j256/ormlite/stmt/ArgumentHolder;)Lcom/j256/ormlite/stmt/Where;
    ...
    const-string p1, "Either the column name or SqlType must be set on each argument"
...
.method public toString()Ljava/lang/String;
    ...
    .line 566
    const-string p0, "empty where clause"
