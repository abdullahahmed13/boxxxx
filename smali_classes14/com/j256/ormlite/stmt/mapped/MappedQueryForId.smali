...
.method public static build(Lcom/j256/ormlite/db/DatabaseType;Lcom/j256/ormlite/table/TableInfo;Lcom/j256/ormlite/field/FieldType;)Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;
    ...
    const-string p2, " because it doesn\'t have an id field"
...
.method private logArgs([Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->label:Ljava/lang/String;
...
.method public execute(Lcom/j256/ormlite/support/DatabaseConnection;Ljava/lang/Object;Lcom/j256/ormlite/dao/ObjectCache;)Ljava/lang/Object;
    ...
    iget-object p3, v4, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->label:Ljava/lang/String;

    iget-object v0, v4, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->statement:Ljava/lang/String;
    ...
    invoke-virtual {p2, v1, p3, v0, p1}, Lcom/j256/ormlite/logger/Logger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 48
    :goto_0
    invoke-direct {v4, v2}, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->logArgs([Ljava/lang/Object;)V

    return-object p0

    .line 42
    :cond_2
    sget-object p0, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->logger:Lcom/j256/ormlite/logger/Logger;

    iget-object p2, v4, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->label:Ljava/lang/String;

    iget-object p3, v4, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->statement:Ljava/lang/String;

    invoke-static {p1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    const-string/jumbo v0, "{} using \'{}\' and {} args, got >1 results"

    invoke-virtual {p0, v0, p2, p3, p1}, Lcom/j256/ormlite/logger/Logger;->error(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string p2, " got more than 1 result: "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, v4, Lcom/j256/ormlite/stmt/mapped/MappedQueryForId;->statement:Ljava/lang/String;
