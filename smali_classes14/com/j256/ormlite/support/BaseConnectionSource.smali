...
.method protected clearSpecial(Lcom/j256/ormlite/support/DatabaseConnection;Lcom/j256/ormlite/logger/Logger;)Z
    ...
    .line 85
    const-string p0, "no connection has been saved when clear() called"

    invoke-virtual {p2, p0}, Lcom/j256/ormlite/logger/Logger;->error(Ljava/lang/String;)V
    ...
    .line 89
    iget-object p0, p0, Lcom/j256/ormlite/support/BaseConnectionSource;->specialConnection:Ljava/lang/ThreadLocal;
    ...
    .line 93
    :cond_3
    const-string p0, "connection saved {} is not the one being cleared {}"
    ...
    invoke-virtual {p2, p0, v0, p1}, Lcom/j256/ormlite/logger/Logger;->error(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method protected getSavedConnection()Lcom/j256/ormlite/support/DatabaseConnection;
    ...
    check-cast p0, Lcom/j256/ormlite/support/BaseConnectionSource$NestedConnection;
    ...
    .line 33
    :cond_0
    iget-object p0, p0, Lcom/j256/ormlite/support/BaseConnectionSource$NestedConnection;->connection:Lcom/j256/ormlite/support/DatabaseConnection;
...
.method protected saveSpecial(Lcom/j256/ormlite/support/DatabaseConnection;)Z
    ...
    new-instance v0, Lcom/j256/ormlite/support/BaseConnectionSource$NestedConnection;

    invoke-direct {v0, p1}, Lcom/j256/ormlite/support/BaseConnectionSource$NestedConnection;-><init>(Lcom/j256/ormlite/support/DatabaseConnection;)V
    ...
    .line 64
    :cond_0
    iget-object p0, v0, Lcom/j256/ormlite/support/BaseConnectionSource$NestedConnection;->connection:Lcom/j256/ormlite/support/DatabaseConnection;
    ...
    const-string/jumbo v2, "trying to save connection "
    ...
    const-string v1, " but already have saved connection "
