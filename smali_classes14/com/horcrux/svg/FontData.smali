...
.method constructor <init>(Lcom/facebook/react/bridge/ReadableMap;Lcom/horcrux/svg/FontData;D)V
    ...
    .line 162
    iget-wide v5, p2, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    iput-wide p0, v0, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    .line 167
    iput-wide v5, v0, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    .line 171
    invoke-interface {v1, p0}, Lcom/facebook/react/bridge/ReadableMap;->getType(Ljava/lang/String;)Lcom/facebook/react/bridge/ReadableType;
    ...
    .line 173
    invoke-interface {v1, p0}, Lcom/facebook/react/bridge/ReadableMap;->getDouble(Ljava/lang/String;)D

    move-result-wide p0

    invoke-direct {v0, p2, p0, p1}, Lcom/horcrux/svg/FontData;->handleNumericWeight(Lcom/horcrux/svg/FontData;D)V
    ...
    .line 176
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$FontWeight;->hasEnum(Ljava/lang/String;)Z
    ...
    .line 177
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$FontWeight;->get(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontWeight;

    move-result-object p0

    invoke-static {p0, p2}, Lcom/horcrux/svg/FontData$AbsoluteFontWeight;->from(Lcom/horcrux/svg/TextProperties$FontWeight;Lcom/horcrux/svg/FontData;)I

    move-result p0

    iput p0, v0, Lcom/horcrux/svg/FontData;->absoluteFontWeight:I

    .line 178
    invoke-static {p0}, Lcom/horcrux/svg/FontData$AbsoluteFontWeight;->nearestFontWeight(I)Lcom/horcrux/svg/TextProperties$FontWeight;

    move-result-object p0

    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontWeight:Lcom/horcrux/svg/TextProperties$FontWeight;
    ...
    .line 182
    :cond_3
    invoke-direct {v0, p2}, Lcom/horcrux/svg/FontData;->setInheritedWeight(Lcom/horcrux/svg/FontData;)V
    ...
    invoke-interface {v1, p0}, Lcom/facebook/react/bridge/ReadableMap;->getMap(Ljava/lang/String;)Lcom/facebook/react/bridge/ReadableMap;
    ...
    :cond_5
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontData:Lcom/facebook/react/bridge/ReadableMap;

    :goto_2
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontData:Lcom/facebook/react/bridge/ReadableMap;
    ...
    :cond_6
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontFamily:Ljava/lang/String;

    :goto_3
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontFamily:Ljava/lang/String;

    .line 193
    const-string p0, "fontStyle"
    ...
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$FontStyle;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontStyle;
    ...
    :cond_7
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontStyle:Lcom/horcrux/svg/TextProperties$FontStyle;

    :goto_4
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontStyle:Lcom/horcrux/svg/TextProperties$FontStyle;

    .line 195
    const-string p0, "fontFeatureSettings"
    ...
    .line 197
    :cond_8
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontFeatureSettings:Ljava/lang/String;

    :goto_5
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontFeatureSettings:Ljava/lang/String;

    .line 199
    const-string p0, "fontVariationSettings"
    ...
    .line 201
    :cond_9
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontVariationSettings:Ljava/lang/String;

    :goto_6
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontVariationSettings:Ljava/lang/String;

    .line 203
    const-string p0, "fontVariantLigatures"
    ...
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$FontVariantLigatures;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontVariantLigatures;
    ...
    .line 205
    :cond_a
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->fontVariantLigatures:Lcom/horcrux/svg/TextProperties$FontVariantLigatures;

    :goto_7
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->fontVariantLigatures:Lcom/horcrux/svg/TextProperties$FontVariantLigatures;

    .line 208
    const-string/jumbo p0, "textAnchor"
    ...
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$TextAnchor;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$TextAnchor;
    ...
    .line 210
    :cond_b
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->textAnchor:Lcom/horcrux/svg/TextProperties$TextAnchor;

    :goto_8
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->textAnchor:Lcom/horcrux/svg/TextProperties$TextAnchor;

    .line 212
    const-string/jumbo p0, "textDecoration"
    ...
    invoke-static {p0}, Lcom/horcrux/svg/TextProperties$TextDecoration;->getEnum(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$TextDecoration;
    ...
    .line 214
    :cond_c
    iget-object p0, p2, Lcom/horcrux/svg/FontData;->textDecoration:Lcom/horcrux/svg/TextProperties$TextDecoration;

    :goto_9
    iput-object p0, v0, Lcom/horcrux/svg/FontData;->textDecoration:Lcom/horcrux/svg/TextProperties$TextDecoration;

    .line 216
    const-string p0, "kerning"
    ...
    .line 217
    iget-boolean p1, p2, Lcom/horcrux/svg/FontData;->manualKerning:Z
    ...
    :goto_b
    iput-boolean p1, v0, Lcom/horcrux/svg/FontData;->manualKerning:Z

    if-eqz p0, :cond_f

    .line 222
    iget-wide v5, v0, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    iget-wide p0, p2, Lcom/horcrux/svg/FontData;->kerning:D

    :goto_c
    iput-wide p0, v0, Lcom/horcrux/svg/FontData;->kerning:D

    .line 224
    const-string/jumbo p0, "wordSpacing"
    ...
    const-string/jumbo v2, "wordSpacing"
    ...
    .line 226
    :cond_10
    iget-wide p0, p2, Lcom/horcrux/svg/FontData;->wordSpacing:D

    :goto_d
    iput-wide p0, v0, Lcom/horcrux/svg/FontData;->wordSpacing:D

    .line 228
    const-string p0, "letterSpacing"
    ...
    .line 230
    :cond_11
    iget-wide p0, p2, Lcom/horcrux/svg/FontData;->letterSpacing:D

    :goto_e
    iput-wide p0, v0, Lcom/horcrux/svg/FontData;->letterSpacing:D
...
.method private toAbsolute(Lcom/facebook/react/bridge/ReadableMap;Ljava/lang/String;DDD)D
    ...
    .line 142
    invoke-static/range {p2 .. p8}, Lcom/horcrux/svg/PropHelper;->fromRelative(Ljava/lang/String;DDD)D
