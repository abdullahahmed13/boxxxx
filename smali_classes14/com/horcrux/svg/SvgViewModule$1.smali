...
.method public run()V
    ...
    iget-object p0, p0, Lcom/horcrux/svg/SvgViewModule$1;->val$options:Lcom/facebook/react/bridge/ReadableMap;
    ...
    invoke-virtual {v0, v1, p0}, Lcom/horcrux/svg/SvgView;->toDataURL(II)Ljava/lang/String;
    ...
    .line 70
    invoke-interface {v2, p0}, Lcom/facebook/react/bridge/Callback;->invoke([Ljava/lang/Object;)V

    return-void

    .line 73
    :cond_2
    iget-object p0, p0, Lcom/horcrux/svg/SvgViewModule$1;->val$successCallback:Lcom/facebook/react/bridge/Callback;
