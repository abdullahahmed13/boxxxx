...
.method public applyFilter(Ljava/util/HashMap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Lcom/horcrux/svg/SvgView;->getCtm()Landroid/graphics/Matrix;

    move-result-object p0

    invoke-virtual {p0, v4}, Landroid/graphics/Matrix;->mapRect(Landroid/graphics/RectF;)Z
    ...
    .line 50
    invoke-virtual {v0, p1, p0, v1, v2}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
