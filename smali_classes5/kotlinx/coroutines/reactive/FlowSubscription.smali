...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "requested$volatile"
    ...
    const-string/jumbo v2, "producer$volatile"
...
.method private final flowProcessing(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast p0, Lkotlinx/coroutines/reactive/FlowSubscription;
    ...
    .line 209
    :goto_3
    iget-boolean v1, p0, Lkotlinx/coroutines/reactive/FlowSubscription;->cancellationRequested:Z

    if-eqz v1, :cond_5

    invoke-virtual {p0}, Lkotlinx/coroutines/reactive/FlowSubscription;->isActive()Z

    move-result v1

    if-nez v1, :cond_5

    invoke-virtual {p0}, Lkotlinx/coroutines/reactive/FlowSubscription;->getCancellationException()Ljava/util/concurrent/CancellationException;
...
.method private final synthetic getProducer$volatile()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lkotlinx/coroutines/reactive/FlowSubscription;->producer$volatile:Ljava/lang/Object;
