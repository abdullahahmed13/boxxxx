...
.method public cancel(Z)Z
    ...
    .line 214
    iget-object p0, p0, Lorg/apache/http/pool/AbstractConnPool$2;->val$callback:Lorg/apache/http/concurrent/FutureCallback;

    if-eqz p0, :cond_0

    .line 215
    invoke-interface {p0}, Lorg/apache/http/concurrent/FutureCallback;->cancelled()V
    ...
    .line 212
    iget-object p0, p0, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-static {p0}, Lorg/apache/http/pool/AbstractConnPool;->access$000(Lorg/apache/http/pool/AbstractConnPool;)Ljava/util/concurrent/locks/Lock;
...
.method public get(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/pool/PoolEntry;
    ...
    .line 254
    iget-object p1, v9, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-static {p1}, Lorg/apache/http/pool/AbstractConnPool;->access$400(Lorg/apache/http/pool/AbstractConnPool;)I
    ...
    .line 255
    invoke-virtual {p0}, Lorg/apache/http/pool/PoolEntry;->getUpdated()J

    move-result-wide p1

    iget-object p3, v9, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-static {p3}, Lorg/apache/http/pool/AbstractConnPool;->access$400(Lorg/apache/http/pool/AbstractConnPool;)I
    ...
    invoke-virtual {p1, p0}, Lorg/apache/http/pool/AbstractConnPool;->validate(Lorg/apache/http/pool/PoolEntry;)Z
    ...
    .line 257
    invoke-virtual {p0}, Lorg/apache/http/pool/PoolEntry;->close()V

    .line 258
    iget-object p1, v9, Lorg/apache/http/pool/AbstractConnPool$2;->this$0:Lorg/apache/http/pool/AbstractConnPool;

    invoke-virtual {p1, p0, v1}, Lorg/apache/http/pool/AbstractConnPool;->release(Lorg/apache/http/pool/PoolEntry;Z)V
    :try_end_3
    ...
    :cond_1
    :try_start_5
    iget-object p1, v9, Lorg/apache/http/pool/AbstractConnPool$2;->done:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 264
    iget-object p1, v9, Lorg/apache/http/pool/AbstractConnPool$2;->entryRef:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p1, p0}, Lorg/apache/http/pool/AbstractConnPool;->onLease(Lorg/apache/http/pool/PoolEntry;)V

    .line 267
    iget-object p1, v9, Lorg/apache/http/pool/AbstractConnPool$2;->val$callback:Lorg/apache/http/concurrent/FutureCallback;

    if-eqz p1, :cond_2

    .line 268
    invoke-interface {p1, p0}, Lorg/apache/http/concurrent/FutureCallback;->completed(Ljava/lang/Object;)V
    :try_end_5
    ...
    invoke-virtual {p1, p0, v2}, Lorg/apache/http/pool/AbstractConnPool;->release(Lorg/apache/http/pool/PoolEntry;Z)V
    ...
    .line 278
    invoke-interface {p1, p0}, Lorg/apache/http/concurrent/FutureCallback;->failed(Ljava/lang/Exception;)V
...
.method public isCancelled()Z
    ...
    .line 224
    iget-object p0, p0, Lorg/apache/http/pool/AbstractConnPool$2;->cancelled:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public isDone()Z
    ...
    .line 229
    iget-object p0, p0, Lorg/apache/http/pool/AbstractConnPool$2;->done:Ljava/util/concurrent/atomic/AtomicBoolean;
