...
.method public build()Lorg/apache/http/client/config/RequestConfig;
    ...
    iget-object v2, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->proxy:Lorg/apache/http/HttpHost;

    move-object v4, v3

    iget-object v3, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->localAddress:Ljava/net/InetAddress;

    move-object v5, v4

    iget-boolean v4, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->staleConnectionCheckEnabled:Z

    move-object v6, v5

    iget-object v5, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->cookieSpec:Ljava/lang/String;

    move-object v7, v6

    iget-boolean v6, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->redirectsEnabled:Z

    move-object v8, v7

    iget-boolean v7, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->relativeRedirectsAllowed:Z

    move-object v9, v8

    iget-boolean v8, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->circularRedirectsAllowed:Z

    move-object v10, v9

    iget v9, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->maxRedirects:I

    move-object v11, v10

    iget-boolean v10, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->authenticationEnabled:Z

    move-object v12, v11

    iget-object v11, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->targetPreferredAuthSchemes:Ljava/util/Collection;

    move-object v13, v12

    iget-object v12, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->proxyPreferredAuthSchemes:Ljava/util/Collection;

    move-object v14, v13

    iget v13, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->connectionRequestTimeout:I

    move-object v15, v14

    iget v14, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->connectTimeout:I

    move-object/from16 v16, v15

    iget v15, v0, Lorg/apache/http/client/config/RequestConfig$Builder;->socketTimeout:I
