...
.method protected createAuthSchemeRegistry()Lorg/apache/http/auth/AuthSchemeRegistry;
    ...
    .line 311
    new-instance v0, Lorg/apache/http/impl/auth/NTLMSchemeFactory;

    invoke-direct {v0}, Lorg/apache/http/impl/auth/NTLMSchemeFactory;-><init>()V
    ...
    .line 314
    new-instance v0, Lorg/apache/http/impl/auth/SPNegoSchemeFactory;

    invoke-direct {v0}, Lorg/apache/http/impl/auth/SPNegoSchemeFactory;-><init>()V
    ...
    .line 317
    new-instance v0, Lorg/apache/http/impl/auth/KerberosSchemeFactory;

    invoke-direct {v0}, Lorg/apache/http/impl/auth/KerberosSchemeFactory;-><init>()V
...
.method protected createClientConnectionManager()Lorg/apache/http/conn/ClientConnectionManager;
    ...
    .line 294
    invoke-interface {v2, p0, v0}, Lorg/apache/http/conn/ClientConnectionManagerFactory;->newInstance(Lorg/apache/http/params/HttpParams;Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionManager;
    ...
    .line 296
    :cond_2
    new-instance p0, Lorg/apache/http/impl/conn/BasicClientConnectionManager;
...
.method protected createClientRequestDirector(Lorg/apache/http/protocol/HttpRequestExecutor;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/ConnectionReuseStrategy;Lorg/apache/http/conn/ConnectionKeepAliveStrategy;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/client/HttpRequestRetryHandler;Lorg/apache/http/client/RedirectHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/UserTokenHandler;Lorg/apache/http/params/HttpParams;)Lorg/apache/http/client/RequestDirector;
    ...
    .line 860
    new-instance p0, Lorg/apache/http/impl/client/DefaultRequestDirector;
...
.method protected createCookieSpecRegistry()Lorg/apache/http/cookie/CookieSpecRegistry;
    ...
    .line 344
    new-instance v0, Lorg/apache/http/impl/cookie/IgnoreSpecFactory;

    invoke-direct {v0}, Lorg/apache/http/impl/cookie/IgnoreSpecFactory;-><init>()V
...
.method protected createHttpRoutePlanner()Lorg/apache/http/conn/routing/HttpRoutePlanner;
    ...
    invoke-direct {v0, p0}, Lorg/apache/http/impl/conn/DefaultHttpRoutePlanner;-><init>(Lorg/apache/http/conn/scheme/SchemeRegistry;)V
...
.method protected createProxyAuthenticationStrategy()Lorg/apache/http/client/AuthenticationStrategy;
    ...
    .line 387
    new-instance p0, Lorg/apache/http/impl/client/ProxyAuthenticationStrategy;

    invoke-direct {p0}, Lorg/apache/http/impl/client/ProxyAuthenticationStrategy;-><init>()V
...
.method protected createTargetAuthenticationStrategy()Lorg/apache/http/client/AuthenticationStrategy;
    ...
    .line 375
    new-instance p0, Lorg/apache/http/impl/client/TargetAuthenticationStrategy;

    invoke-direct {p0}, Lorg/apache/http/impl/client/TargetAuthenticationStrategy;-><init>()V
...
.method protected final doExecute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/client/methods/CloseableHttpResponse;
    ...
    invoke-static {v14, v3}, Lorg/apache/http/util/Args;->notNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 775
    :cond_0
    new-instance v4, Lorg/apache/http/protocol/DefaultedHttpContext;

    invoke-direct {v4, v2, v3}, Lorg/apache/http/protocol/DefaultedHttpContext;-><init>(Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/protocol/HttpContext;)V
    ...
    invoke-direct {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getProtocolProcessor()Lorg/apache/http/protocol/HttpProcessor;
    ...
    invoke-virtual {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getRedirectStrategy()Lorg/apache/http/client/RedirectStrategy;

    move-result-object v9

    invoke-virtual {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getTargetAuthenticationStrategy()Lorg/apache/http/client/AuthenticationStrategy;

    move-result-object v10

    invoke-virtual {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getProxyAuthenticationStrategy()Lorg/apache/http/client/AuthenticationStrategy;
    ...
    .line 796
    invoke-virtual {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getConnectionBackoffStrategy()Lorg/apache/http/client/ConnectionBackoffStrategy;

    move-result-object v4

    .line 797
    invoke-virtual {v1}, Lorg/apache/http/impl/client/AbstractHttpClient;->getBackoffManager()Lorg/apache/http/client/BackoffManager;
    ...
    invoke-interface {v1, v6}, Lorg/apache/http/params/HttpParams;->getParameter(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 805
    :goto_1
    invoke-interface {v3, v1, v14, v15}, Lorg/apache/http/conn/routing/HttpRoutePlanner;->determineRoute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/conn/routing/HttpRoute;
    ...
    .line 809
    :try_start_2
    invoke-interface {v2, v0, v14, v15}, Lorg/apache/http/client/RequestDirector;->execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    .line 828
    :try_start_3
    invoke-interface {v4, v0}, Lorg/apache/http/client/ConnectionBackoffStrategy;->shouldBackoff(Lorg/apache/http/HttpResponse;)Z
    ...
    .line 829
    invoke-interface {v5, v1}, Lorg/apache/http/client/BackoffManager;->backOff(Lorg/apache/http/conn/routing/HttpRoute;)V

    return-object v0

    .line 831
    :cond_2
    invoke-interface {v5, v1}, Lorg/apache/http/client/BackoffManager;->probe(Lorg/apache/http/conn/routing/HttpRoute;)V
    ...
    .line 817
    invoke-interface {v4, v0}, Lorg/apache/http/client/ConnectionBackoffStrategy;->shouldBackoff(Ljava/lang/Throwable;)Z
