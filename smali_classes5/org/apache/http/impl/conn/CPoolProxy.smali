...
.method public bind(Ljava/net/Socket;)V
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->bind(Ljava/net/Socket;)V
...
.method public close()V
    ...
    .line 84
    iget-object p0, p0, Lorg/apache/http/impl/conn/CPoolProxy;->poolEntry:Lorg/apache/http/impl/conn/CPoolEntry;
...
.method public flush()V
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->flush()V
...
.method public getId()Ljava/lang/String;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getId()Ljava/lang/String;
...
.method public getLocalAddress()Ljava/net/InetAddress;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getLocalAddress()Ljava/net/InetAddress;
...
.method public getLocalPort()I
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getLocalPort()I
...
.method public getMetrics()Lorg/apache/http/HttpConnectionMetrics;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getMetrics()Lorg/apache/http/HttpConnectionMetrics;
...
.method public getRemoteAddress()Ljava/net/InetAddress;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getRemoteAddress()Ljava/net/InetAddress;
...
.method public getRemotePort()I
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getRemotePort()I
...
.method public getSocket()Ljava/net/Socket;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getSocket()Ljava/net/Socket;
...
.method public getSocketTimeout()I
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->getSocketTimeout()I
...
.method public isOpen()Z
    ...
    .line 101
    invoke-virtual {p0}, Lorg/apache/http/impl/conn/CPoolEntry;->isClosed()Z
...
.method public isResponseAvailable(I)Z
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->isResponseAvailable(I)Z
...
.method public receiveResponseEntity(Lorg/apache/http/HttpResponse;)V
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->receiveResponseEntity(Lorg/apache/http/HttpResponse;)V
...
.method public receiveResponseHeader()Lorg/apache/http/HttpResponse;
    ...
    invoke-interface {p0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->receiveResponseHeader()Lorg/apache/http/HttpResponse;
...
.method public sendRequestEntity(Lorg/apache/http/HttpEntityEnclosingRequest;)V
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->sendRequestEntity(Lorg/apache/http/HttpEntityEnclosingRequest;)V
...
.method public sendRequestHeader(Lorg/apache/http/HttpRequest;)V
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->sendRequestHeader(Lorg/apache/http/HttpRequest;)V
...
.method public setSocketTimeout(I)V
    ...
    invoke-interface {p0, p1}, Lorg/apache/http/conn/ManagedHttpClientConnection;->setSocketTimeout(I)V
...
.method public shutdown()V
    ...
    .line 94
    invoke-virtual {p0}, Lorg/apache/http/impl/conn/CPoolEntry;->shutdownConnection()V
