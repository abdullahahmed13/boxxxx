...
.method constructor <init>(Ljava/util/Random;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[BILjava/lang/String;[BLjava/security/cert/Certificate;[B[B)V
    ...
    .line 1519
    invoke-direct {v0}, Lorg/apache/http/impl/auth/NTLMEngineImpl$NTLMMessage;-><init>()V
    ...
    .line 1538
    iput-boolean v5, v0, Lorg/apache/http/impl/auth/NTLMEngineImpl$Type3Message;->computeMic:Z
    ...
    .line 1544
    :goto_0
    new-instance v5, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;
    ...
    invoke-direct/range {v5 .. v14}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;-><init>(Ljava/util/Random;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;[BLjava/lang/String;[B)V
    ...
    .line 1561
    :try_start_0
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLMv2Response()[B
    ...
    .line 1562
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getLMv2Response()[B
    ...
    .line 1564
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getLanManagerSessionKey()[B
    ...
    .line 1566
    :cond_1
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLMv2UserSessionKey()[B
    ...
    .line 1572
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLM2SessionResponse()[B
    ...
    .line 1573
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getLM2SessionResponse()[B
    ...
    .line 1577
    :cond_3
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLM2SessionResponseUserSessionKey()[B
    ...
    .line 1580
    :cond_4
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLMResponse()[B
    ...
    .line 1581
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getLMResponse()[B
    ...
    .line 1585
    :cond_5
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getNTLMUserSessionKey()[B
    ...
    .line 1597
    :cond_6
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getLMUserSessionKey()[B
    ...
    .line 1603
    invoke-virtual {v5}, Lorg/apache/http/impl/auth/NTLMEngineImpl$CipherGen;->getSecondaryKey()[B
    ...
    .line 1613
    iput-object v6, v0, Lorg/apache/http/impl/auth/NTLMEngineImpl$Type3Message;->sessionKey:[B

    .line 1614
    iput-object v6, v0, Lorg/apache/http/impl/auth/NTLMEngineImpl$Type3Message;->exportedSessionKey:[B
    ...
    :cond_a
    iput-object v6, v0, Lorg/apache/http/impl/auth/NTLMEngineImpl$Type3Message;->domainBytes:[B
...
.method protected buildMessage()V
    ...
    .line 1658
    invoke-virtual {v0, v15, v9}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Type3Message;->prepareResponse(II)V
