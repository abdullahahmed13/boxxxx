...
.method public process(Ljava/lang/String;)Lorg/jose4j/jwt/consumer/JwtContext;
    ...
    invoke-direct {v0, v7, p1}, Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;-><init>(ILjava/lang/String;)V

    .line 429
    new-instance p1, Lorg/jose4j/jwt/consumer/InvalidJwtException;

    invoke-direct {p1, v1, v0, p0, v4}, Lorg/jose4j/jwt/consumer/InvalidJwtException;-><init>(Ljava/lang/String;Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;Ljava/lang/Throwable;Lorg/jose4j/jwt/consumer/JwtContext;)V
...
.method public processContext(Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    invoke-virtual {v1}, Lorg/jose4j/jwt/consumer/JwtContext;->getJoseObjects()Ljava/util/List;
    ...
    .line 194
    iget-boolean v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->skipSignatureVerification:Z

    if-nez v15, :cond_7

    .line 196
    iget-object v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->jwsProviderContext:Lorg/jose4j/jca/ProviderContext;
    ...
    .line 201
    :cond_0
    iget-boolean v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->relaxVerificationKeyValidation:Z
    ...
    .line 206
    :cond_1
    iget-object v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->jwsAlgorithmConstraints:Lorg/jose4j/jwa/AlgorithmConstraints;
    ...
    .line 211
    iget-boolean v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->skipVerificationKeyResolutionOnNone:Z

    if-nez v15, :cond_4

    .line 213
    :cond_3
    iget-object v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->verificationKeyResolver:Lorg/jose4j/keys/resolvers/VerificationKeyResolver;
    ...
    .line 217
    :cond_4
    iget-object v15, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->jwsCustomizer:Lorg/jose4j/jwt/consumer/JwsCustomizer;
    ...
    invoke-direct {v0, v7, v1}, Lorg/jose4j/jwt/consumer/InvalidJwtSignatureException;-><init>(Lorg/jose4j/jws/JsonWebSignature;Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    .line 239
    iget-object v8, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->decryptionKeyResolver:Lorg/jose4j/keys/resolvers/DecryptionKeyResolver;
    ...
    const-string v5, "Key resolution problem."

    const/16 v6, 0x11

    invoke-direct {v0, v6, v5}, Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;-><init>(ILjava/lang/String;)V
    ...
    const-string v6, "The resolved decryption key is different than the one originally used to decrypt the JWE."

    invoke-direct {v5, v6, v0, v1}, Lorg/jose4j/jwt/consumer/InvalidJwtException;-><init>(Ljava/lang/String;Ljava/util/List;Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    :cond_a
    :goto_2
    iget-object v8, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->jweAlgorithmConstraints:Lorg/jose4j/jwa/AlgorithmConstraints;
    ...
    .line 251
    :cond_b
    iget-object v8, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->jweContentEncryptionAlgorithmConstraints:Lorg/jose4j/jwa/AlgorithmConstraints;
    ...
    invoke-direct {v2, v6, v4}, Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;-><init>(ILjava/lang/String;)V

    .line 287
    new-instance v4, Lorg/jose4j/jwt/consumer/InvalidJwtException;

    invoke-direct {v4, v3, v2, v0, v1}, Lorg/jose4j/jwt/consumer/InvalidJwtException;-><init>(Ljava/lang/String;Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;Ljava/lang/Throwable;Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    .line 292
    :cond_11
    iget-boolean v2, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->requireSignature:Z
    ...
    invoke-direct {v0, v2, v3}, Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;-><init>(ILjava/lang/String;)V
    ...
    invoke-virtual {v1}, Lorg/jose4j/jwt/consumer/JwtContext;->getJwt()Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v0, v1}, Lorg/jose4j/jwt/consumer/InvalidJwtException;-><init>(Ljava/lang/String;Ljava/util/List;Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    :cond_13
    :goto_5
    iget-boolean v2, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->requireEncryption:Z
    ...
    :cond_15
    :goto_6
    iget-boolean v2, v0, Lorg/jose4j/jwt/consumer/JwtConsumer;->requireIntegrity:Z
...
.method public processToClaims(Ljava/lang/String;)Lorg/jose4j/jwt/JwtClaims;
    ...
    invoke-virtual {p0}, Lorg/jose4j/jwt/consumer/JwtContext;->getJwtClaims()Lorg/jose4j/jwt/JwtClaims;
...
.method validate(Lorg/jose4j/jwt/consumer/JwtContext;)V
    ...
    invoke-virtual {v1}, Lorg/jose4j/jwt/JwtClaims;->getRawJson()Ljava/lang/String;
    ...
    .line 466
    new-instance v1, Lorg/jose4j/jwt/consumer/InvalidJwtException;

    invoke-direct {v1, p0, v0, p1}, Lorg/jose4j/jwt/consumer/InvalidJwtException;-><init>(Ljava/lang/String;Ljava/util/List;Lorg/jose4j/jwt/consumer/JwtContext;)V
