...
.method public compress([B)[B
    ...
    invoke-direct {v1, v0, p0}, Ljava/util/zip/DeflaterOutputStream;-><init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;)V
    :try_end_1
    ...
    const-string v1, "Problem compressing data."
...
.method public decompress([B)[B
    ...
    .line 64
    :goto_0
    invoke-virtual {v1, p1}, Ljava/util/zip/InflaterInputStream;->read([B)I
...
.method public getKeyPersuasion()Lorg/jose4j/keys/KeyPersuasion;
    ...
    .line 97
    sget-object p0, Lorg/jose4j/keys/KeyPersuasion;->NONE:Lorg/jose4j/keys/KeyPersuasion;
