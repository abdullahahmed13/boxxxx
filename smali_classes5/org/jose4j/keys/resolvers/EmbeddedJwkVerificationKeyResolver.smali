...
.method public getJwk()Lorg/jose4j/jwk/PublicJsonWebKey;
    ...
    .line 50
    iget-object p0, p0, Lorg/jose4j/keys/resolvers/EmbeddedJwkVerificationKeyResolver;->jwk:Lorg/jose4j/jwk/PublicJsonWebKey;
...
.method public resolveKey(Lorg/jose4j/jws/JsonWebSignature;Ljava/util/List;)Ljava/security/Key;
    ...
    const-string p1, "No jwk in JWS header"
    ...
    const-string p2, "Problem processing jwk from JWS header"

    invoke-direct {p1, p2, p0}, Lorg/jose4j/lang/UnresolvableKeyException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
