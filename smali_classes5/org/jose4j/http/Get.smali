...
.method private getBody(Ljava/net/URLConnection;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget p0, p0, Lorg/jose4j/http/Get;->responseBodySizeLimit:I

    invoke-virtual {v0, p0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object p0

    const-string v0, " characters have been read from the response body."
    ...
    invoke-direct {p2, p0}, Lorg/jose4j/http/Get$ResponseBodyTooLargeException;-><init>(Ljava/lang/String;)V

    throw p2

    .line 133
    :cond_2
    sget-object p0, Lorg/jose4j/http/Get;->log:Lorg/slf4j/Logger;

    const-string p2, "read {} characters"

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    invoke-interface {p0, p2, v2}, Lorg/slf4j/Logger;->debug(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
...
.method private getCharset(Ljava/net/URLConnection;)Ljava/lang/String;
    ...
    const-string v2, "Unexpected problem attempted to determine the charset from the Content-Type ({}) so will default to using UTF8: {}"
...
.method private getRetryWaitTime(I)J
    ...
    .line 186
    iget-wide p0, p0, Lorg/jose4j/http/Get;->initialRetryWaitTime:J
...
.method private setUpTls(Ljava/net/URLConnection;)V
    ...
    .line 148
    :cond_0
    iget-object p0, p0, Lorg/jose4j/http/Get;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;
...
.method public setTrustedCertificates(Ljava/util/Collection;)V
    ...
    const-string v0, "Unable to initialize socket factory with custom trusted  certificates."
