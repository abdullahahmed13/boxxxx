...
.method public isAvailable()Z
    ...
    invoke-virtual {v0, v1, v2, v3, p0}, Lorg/jose4j/jwe/SimpleAeadCipher;->isAvailable(Lorg/slf4j/Logger;IILjava/lang/String;)Z
...
.method public manageForEncrypt(Ljava/security/Key;Lorg/jose4j/jwe/ContentEncryptionKeyDescriptor;Lorg/jose4j/jwx/Headers;[BLorg/jose4j/jca/ProviderContext;)Lorg/jose4j/jwe/ContentEncryptionKeys;
    ...
    invoke-virtual {p3, p4}, Lorg/jose4j/jwx/Headers;->getStringHeaderValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 67
    invoke-static {v1, v0}, Lorg/jose4j/lang/ByteUtil;->randomBytes(ILjava/security/SecureRandom;)[B
    ...
    .line 69
    invoke-virtual {p3, p4, v1}, Lorg/jose4j/jwx/Headers;->setStringHeaderValue(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 73
    :cond_1
    invoke-virtual {p2, v1}, Lorg/jose4j/base64url/Base64Url;->base64UrlDecode(Ljava/lang/String;)[B
    ...
    .line 81
    invoke-virtual {p2, p0}, Lorg/jose4j/base64url/Base64Url;->base64UrlEncode([B)Ljava/lang/String;
    ...
    invoke-virtual {p3, p2, p0}, Lorg/jose4j/jwx/Headers;->setStringHeaderValue(Ljava/lang/String;Ljava/lang/String;)V

    .line 84
    new-instance p0, Lorg/jose4j/jwe/ContentEncryptionKeys;

    invoke-direct {p0, v4, p1}, Lorg/jose4j/jwe/ContentEncryptionKeys;-><init>([B[B)V
...
.method validateKey(Ljava/security/Key;)V
    ...
    iget p0, p0, Lorg/jose4j/jwe/AesGcmKeyEncryptionAlgorithm;->keyByteLength:I
