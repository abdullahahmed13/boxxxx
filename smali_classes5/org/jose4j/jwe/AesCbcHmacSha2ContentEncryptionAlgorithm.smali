...
.method private getAdditionalAuthenticatedDataLengthBytes([B)[B
    ...
    .line 181
    invoke-static {p0, p1}, Lorg/jose4j/lang/ByteUtil;->getBytes(J)[B
...
.method public decrypt(Lorg/jose4j/jwe/ContentEncryptionParts;[B[BLorg/jose4j/jwx/Headers;Lorg/jose4j/jca/ProviderContext;)[B
    ...
    .line 139
    new-instance v2, Lorg/jose4j/keys/HmacKey;

    invoke-static {p3}, Lorg/jose4j/lang/ByteUtil;->leftHalf([B)[B

    move-result-object v3

    invoke-direct {v2, v3}, Lorg/jose4j/keys/HmacKey;-><init>([B)V
    ...
    invoke-static {v3, v2, p4}, Lorg/jose4j/mac/MacUtil;->getInitializedMac(Ljava/lang/String;Ljava/security/Key;Ljava/lang/String;)Ljavax/crypto/Mac;
    ...
    invoke-static {p2, p4, v2}, Lorg/jose4j/lang/ByteUtil;->subArray([BII)[B
    ...
    invoke-direct {p1, p2}, Lorg/jose4j/keys/AesKey;-><init>([B)V
    ...
    invoke-static {p2, v0}, Lorg/jose4j/jwe/CipherUtil;->getCipher(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/Cipher;
    ...
    invoke-direct {p2, p0, p1}, Lorg/jose4j/lang/JoseException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw p2

    .line 146
    :cond_0
    new-instance p0, Lorg/jose4j/base64url/Base64Url;

    invoke-direct {p0}, Lorg/jose4j/base64url/Base64Url;-><init>()V
    ...
    .line 148
    new-instance p1, Lorg/jose4j/lang/IntegrityException;
    ...
    invoke-direct {p1, p0}, Lorg/jose4j/lang/IntegrityException;-><init>(Ljava/lang/String;)V
...
.method public encrypt([B[B[BLorg/jose4j/jwx/Headers;[BLorg/jose4j/jca/ProviderContext;)Lorg/jose4j/jwe/ContentEncryptionParts;
    ...
    .line 84
    invoke-virtual/range {p0 .. p6}, Lorg/jose4j/jwe/AesCbcHmacSha2ContentEncryptionAlgorithm;->encrypt([B[B[B[BLorg/jose4j/jwx/Headers;Lorg/jose4j/jca/ProviderContext;)Lorg/jose4j/jwe/ContentEncryptionParts;
...
.method encrypt([B[B[B[BLorg/jose4j/jwx/Headers;Lorg/jose4j/jca/ProviderContext;)Lorg/jose4j/jwe/ContentEncryptionParts;
    ...
    .line 122
    filled-new-array {p2, p4, p1, p5}, [[B
    ...
    invoke-static {p2, p3, p0}, Lorg/jose4j/lang/ByteUtil;->subArray([BII)[B
    ...
    invoke-direct {p2, p4, p1, p0}, Lorg/jose4j/jwe/ContentEncryptionParts;-><init>([B[B[B)V
...
.method public getContentEncryptionKeyDescriptor()Lorg/jose4j/jwe/ContentEncryptionKeyDescriptor;
    ...
    .line 77
    iget-object p0, p0, Lorg/jose4j/jwe/AesCbcHmacSha2ContentEncryptionAlgorithm;->contentEncryptionKeyDescriptor:Lorg/jose4j/jwe/ContentEncryptionKeyDescriptor;
...
.method public getHmacJavaAlgorithm()Ljava/lang/String;
    ...
    .line 67
    iget-object p0, p0, Lorg/jose4j/jwe/AesCbcHmacSha2ContentEncryptionAlgorithm;->hmacJavaAlgorithm:Ljava/lang/String;
...
.method public getTagTruncationLength()I
    ...
    .line 72
    iget p0, p0, Lorg/jose4j/jwe/AesCbcHmacSha2ContentEncryptionAlgorithm;->tagTruncationLength:I
