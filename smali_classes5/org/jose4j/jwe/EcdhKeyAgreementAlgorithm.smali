...
.method private checkPointIsOnCurve(Ljava/security/interfaces/ECPublicKey;Ljava/security/interfaces/ECPrivateKey;)V
    ...
    invoke-static {p0}, Lorg/jose4j/keys/EllipticCurves;->getName(Ljava/security/spec/EllipticCurve;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0}, Lorg/jose4j/lang/JoseException;-><init>(Ljava/lang/String;)V
...
.method private generateEcdhSecret(Ljava/security/PrivateKey;Ljava/security/PublicKey;Lorg/jose4j/jca/ProviderContext;)[B
    ...
    invoke-direct {p2, p0, p1}, Lorg/jose4j/lang/InvalidKeyException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private getKeyAgreement(Ljava/lang/String;)Ljavax/crypto/KeyAgreement;
    ...
    :cond_0
    invoke-static {p0, p1}, Ljavax/crypto/KeyAgreement;->getInstance(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/KeyAgreement;
    ...
    const-string v2, " KeyAgreement with provider "
    ...
    const-string v1, " KeyAgreement available."
    ...
    invoke-direct {v0, p0, p1}, Lorg/jose4j/lang/UncheckedJoseException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private kdf(Lorg/jose4j/jwe/ContentEncryptionKeyDescriptor;Lorg/jose4j/jwx/Headers;[BLorg/jose4j/jca/ProviderContext;)[B
    ...
    .line 143
    iget-object p0, p0, Lorg/jose4j/jwe/EcdhKeyAgreementAlgorithm;->algorithmIdHeaderName:Ljava/lang/String;

    invoke-virtual {p2, p0}, Lorg/jose4j/jwx/Headers;->getStringHeaderValue(Ljava/lang/String;)Ljava/lang/String;
...
.method public isAvailable()Z
    ...
    invoke-static {v0, p0}, Lorg/jose4j/jwa/AlgorithmAvailability;->isAvailable(Ljava/lang/String;Ljava/lang/String;)Z
...
.method manageForEncrypt(Ljava/security/Key;Lorg/jose4j/jwe/ContentEncryptionKeyDescriptor;Lorg/jose4j/jwx/Headers;Lorg/jose4j/jwk/PublicJsonWebKey;Lorg/jose4j/jca/ProviderContext;)Lorg/jose4j/jwe/ContentEncryptionKeys;
    ...
    invoke-direct {p1, p0, p2}, Lorg/jose4j/jwe/ContentEncryptionKeys;-><init>([B[B)V
...
.method public validateDecryptionKey(Ljava/security/Key;Lorg/jose4j/jwe/ContentEncryptionAlgorithm;)V
    ...
    .line 194
    const-class p0, Ljava/security/interfaces/ECPrivateKey;

    invoke-static {p1, p0}, Lorg/jose4j/jwx/KeyValidationSupport;->castKey(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/Key;
...
.method public validateEncryptionKey(Ljava/security/Key;Lorg/jose4j/jwe/ContentEncryptionAlgorithm;)V
    ...
    .line 188
    const-class p0, Ljava/security/interfaces/ECPublicKey;
