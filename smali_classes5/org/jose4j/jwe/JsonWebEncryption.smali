...
.method compress(Lorg/jose4j/jwx/Headers;[B)[B
    ...
    invoke-virtual {p1, p0}, Lorg/jose4j/jwx/Headers;->getStringHeaderValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 248
    invoke-virtual {p1}, Lorg/jose4j/jwa/AlgorithmFactoryFactory;->getCompressionAlgorithmFactory()Lorg/jose4j/jwa/AlgorithmFactory;

    move-result-object p1

    .line 249
    invoke-virtual {p1, p0}, Lorg/jose4j/jwa/AlgorithmFactory;->getAlgorithm(Ljava/lang/String;)Lorg/jose4j/jwa/Algorithm;

    move-result-object p0

    check-cast p0, Lorg/jose4j/zip/CompressionAlgorithm;

    .line 250
    invoke-interface {p0, p2}, Lorg/jose4j/zip/CompressionAlgorithm;->compress([B)[B
...
.method decompress(Lorg/jose4j/jwx/Headers;[B)[B
    ...
    .line 237
    invoke-interface {p0, p2}, Lorg/jose4j/zip/CompressionAlgorithm;->decompress([B)[B
...
.method public getCompactSerialization()Ljava/lang/String;
    ...
    const-string v0, "The plaintext payload for the JWE has not been set."
...
.method public getContentEncryptionAlgorithm()Lorg/jose4j/jwe/ContentEncryptionAlgorithm;
    ...
    .line 134
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->contentEncryptionAlgorithmConstraints:Lorg/jose4j/jwa/AlgorithmConstraints;

    invoke-virtual {p0, v0}, Lorg/jose4j/jwa/AlgorithmConstraints;->checkConstraint(Ljava/lang/String;)V
    ...
    .line 136
    invoke-virtual {p0}, Lorg/jose4j/jwa/AlgorithmFactoryFactory;->getJweContentEncryptionAlgorithmFactory()Lorg/jose4j/jwa/AlgorithmFactory;

    move-result-object p0

    .line 137
    invoke-virtual {p0, v0}, Lorg/jose4j/jwa/AlgorithmFactory;->getAlgorithm(Ljava/lang/String;)Lorg/jose4j/jwa/Algorithm;

    move-result-object p0

    check-cast p0, Lorg/jose4j/jwe/ContentEncryptionAlgorithm;

    return-object p0

    .line 131
    :cond_0
    new-instance p0, Lorg/jose4j/lang/InvalidAlgorithmException;

    const-string v0, "Content encryption header (enc) not set."

    invoke-direct {p0, v0}, Lorg/jose4j/lang/InvalidAlgorithmException;-><init>(Ljava/lang/String;)V
...
.method public getContentEncryptionKey()[B
    ...
    .line 299
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->contentEncryptionKey:[B
...
.method getEncodedHeaderAsciiBytesForAdditionalAuthenticatedData()[B
    ...
    .line 226
    invoke-static {p0}, Lorg/jose4j/lang/StringUtil;->getBytesAscii(Ljava/lang/String;)[B
...
.method public getEncryptedKey()[B
    ...
    .line 220
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->encryptedKey:[B
...
.method public getIv()[B
    ...
    .line 314
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->iv:[B
...
.method getKeyManagementModeAlgorithm(Z)Lorg/jose4j/jwe/KeyManagementAlgorithm;
    ...
    .line 158
    invoke-virtual {p0}, Lorg/jose4j/jwa/AlgorithmFactoryFactory;->getJweKeyManagementAlgorithmFactory()Lorg/jose4j/jwa/AlgorithmFactory;
    ...
    check-cast p0, Lorg/jose4j/jwe/KeyManagementAlgorithm;
    ...
    invoke-direct {p0, p1}, Lorg/jose4j/lang/InvalidAlgorithmException;-><init>(Ljava/lang/String;)V
...
.method public getPlaintextBytes()[B
    ...
    .line 81
    :cond_0
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->plaintext:[B
...
.method public getPlaintextString()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/jose4j/jwe/JsonWebEncryption;->plaintextCharEncoding:Ljava/lang/String;

    invoke-static {v0, p0}, Lorg/jose4j/lang/StringUtil;->newString([BLjava/lang/String;)Ljava/lang/String;
